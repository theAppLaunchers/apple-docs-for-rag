...
-  setMetadata(\_:forPersistentStoreOfType:at:options:) Deprecated
...
The type of store. If `nil`, Core Data automatically attempts to determine the store class to use.
