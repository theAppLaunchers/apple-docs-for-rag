...
- Interger Average, Rounded Down (short)
- Interger Average, Rounded Down (uinteger)
- Interger Average, Rounded Down (vector3uinteger)
- Interger Average, Rounded Down (vector3ulong)
- Interger Average, Rounded Down (vector2long)
- Interger Average, Rounded Down (integer)
- Interger Average, Rounded Down (vector2short)
- Interger Average, Rounded Down (vector3long)
- Interger Average, Rounded Down (vector2i)
- Interger Average, Rounded Down (vector2ulong)
- Interger Average, Rounded Down (vector2uinteger)
- Interger Average, Rounded Down (long)
- Interger Average, Rounded Down (vector2ushort)
- Interger Average, Rounded Down (vector3short)
- Interger Average, Rounded Down (ulong)
- Interger Average, Rounded Down (ushort)
- Interger Average, Rounded Down (vector3ushort)
- Interger Average, Rounded Down (vector3i)
