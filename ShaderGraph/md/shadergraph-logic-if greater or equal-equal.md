...
`True Result`  
The output of the node if the `Value1` input parameter is greater than or equal to the `Value2` input parameter.

`False Result`  
The output of the node if the `Value1` input parameter isn’t greater than or equal to the `Value2` input parameter.
