...
- Multiply Add Saturate (short)
- Multiply Add Saturate (uinteger)
- Multiply Add Saturate (vector2long)
- Multiply Add Saturate (vector2ushort)
- Multiply Add Saturate (vector2ulong)
- Multiply Add Saturate (vector3uinteger)
- Multiply Add Saturate (vector2short)
- Multiply Add Saturate (ushort)
- Multiply Add Saturate (vector3short)
- Multiply Add Saturate (vector3ushort)
- Multiply Add Saturate (long)
- Multiply Add Saturate (ulong)
- Multiply Add Saturate (vector2uinteger)
- Multiply Add Saturate (vector3long)
- Multiply Add Saturate (vector3i)
- Multiply Add Saturate (vector2i)
- Multiply Add Saturate (vector3ulong)
- Multiply Add Saturate (integer)
