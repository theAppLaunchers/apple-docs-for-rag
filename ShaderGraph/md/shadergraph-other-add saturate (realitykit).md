...
- Add Saturate (short)
- Add Saturate (vector3i)
- Add Saturate (vector3ushort)
- Add Saturate (vector2short)
- Add Saturate (ulong)
- Add Saturate (vector2uinteger)
- Add Saturate (vector2i)
- Add Saturate (vector2ulong)
- Add Saturate (vector3uinteger)
- Add Saturate (vector2long)
- Add Saturate (uinteger)
- Add Saturate (vector3long)
- Add Saturate (vector3ulong)
- Add Saturate (long)
- Add Saturate (vector3short)
- Add Saturate (ushort)
- Add Saturate (integer)
- Add Saturate (vector2ushort)
