...
- Rotate Bits (short)
- Rotate Bits (integer)
- Rotate Bits (vector2short)
- Rotate Bits (vector3i)
- Rotate Bits (vector3ushort)
- Rotate Bits (vector2i)
- Rotate Bits (ulong)
- Rotate Bits (vector3uinteger)
- Rotate Bits (vector2ulong)
- Rotate Bits (uinteger)
- Rotate Bits (ushort)
- Rotate Bits (vector2uinteger)
- Rotate Bits (vector2long)
- Rotate Bits (vector2ushort)
- Rotate Bits (vector3long)
- Rotate Bits (long)
- Rotate Bits (vector3ulong)
- Rotate Bits (vector3short)
