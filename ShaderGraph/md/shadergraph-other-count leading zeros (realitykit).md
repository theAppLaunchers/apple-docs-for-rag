...
- Count Leading Zeros (short)
- Count Leading Zeros (vector2ulong)
- Count Leading Zeros (vector2long)
- Count Leading Zeros (integer)
- Count Leading Zeros (vector3ulong)
- Count Leading Zeros (vector2short)
- Count Leading Zeros (ulong)
- Count Leading Zeros (vector2i)
- Count Leading Zeros (vector3short)
- Count Leading Zeros (uinteger)
- Count Leading Zeros (vector2ushort)
- Count Leading Zeros (vector3long)
- Count Leading Zeros (vector3ushort)
- Count Leading Zeros (vector3uinteger)
- Count Leading Zeros (vector2uinteger)
- Count Leading Zeros(long)
- Count Leading Zeros (vector3i)
- Count Leading Zeros (ushort)
