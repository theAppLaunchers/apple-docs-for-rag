...
- Absolute Diff (short)
- Absolute Diff (vector2i)
- Absolute Diff (vector3i)
- Absolute Diff (vector4short)
- Absolute Diff (long)
- Absolute Diff (vector3long)
- Absolute Diff (vector3short)
- Absolute Diff (vector2short)
- Absolute Diff (integer)
- Absolute Diff (vector4i)
- Absolute Diff (vector2long)
- Absolute Diff (vector4long)
