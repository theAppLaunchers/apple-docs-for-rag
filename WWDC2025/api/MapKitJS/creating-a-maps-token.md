...
## [Overview](/documentation/MapKitJS/creating-a-maps-token#overview)
...
### [Create the Maps token](/documentation/MapKitJS/creating-a-maps-token#Create-the-Maps-token)
...
The token appears in the list under Website domains. Click the copy icon to copy the token to your clipboard, or click the name of the token to view its details. Use your new token to access MapKit JS services through [`mapkit`](/documentation/mapkitjs/mapkit).

If you need to revoke your token, click Revoke. This invalidates the token and you can no longer use it with MapKit JS.

## [See Also](/documentation/MapKitJS/creating-a-maps-token#see-also)

### [Essentials](/documentation/MapKitJS/creating-a-maps-token#Essentials)
