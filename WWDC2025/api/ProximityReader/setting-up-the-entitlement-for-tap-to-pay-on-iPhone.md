...
## [Overview](/documentation/ProximityReader/setting-up-the-entitlement-for-tap-to-pay-on-iPhone#Overview)

Tap to Pay on iPhone lets merchants accept contactless payments using an app on their iPhone, without having to connect external hardware. Your app uses the [ProximityReader](/documentation/proximityreader) framework to read the payment method someone presents.
...
### [Add the Tap to Pay on iPhone capability to your App ID](/documentation/ProximityReader/setting-up-the-entitlement-for-tap-to-pay-on-iPhone#Add-the-Tap-to-Pay-on-iPhone-capability-to-your-App-ID)
...
### [Download the new provisioning profile](/documentation/ProximityReader/setting-up-the-entitlement-for-tap-to-pay-on-iPhone#Download-the-new-provisioning-profile)
...
### [Add an entitlements file](/documentation/ProximityReader/setting-up-the-entitlement-for-tap-to-pay-on-iPhone#Add-an-entitlements-file)
...
## [See Also](/documentation/ProximityReader/setting-up-the-entitlement-for-tap-to-pay-on-iPhone#see-also)

### [Payment card reader](/documentation/ProximityReader/setting-up-the-entitlement-for-tap-to-pay-on-iPhone#Payment-card-reader)
