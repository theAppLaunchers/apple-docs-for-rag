...
## [Overview](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#Overview)
...
An _indirect dependency_ is any other library dependency that doesn’t meet those two criteria — for example, a pre-built library, or a library’s dependencies.
...
*   Xcode embeds mergeable target products in either the merged binary product or into a product, such as an app, that contains the merged binary product. Xcode does _not_ include the binaries from the libraries in the embedded copy.
    

Note

Xcode does not automatically build indirect dependencies as mergeable in release builds. To configure indirect dependencies for merging, see the [Manually configure merging](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#Manually-configure-merging) section below.
...
### [Manually configure merging](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#Manually-configure-merging)
...
For each dependent library that you want to use merging, add the build setting `MERGEABLE_LIBRARY`, and set it to `YES`. For more information on the `MERGEABLE_LIBRARY` build setting, see [Build Mergeable Library](/documentation/xcode/build-settings-reference#Build-Mergeable-Library).

### [Reduce dependencies with a group library](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#Reduce-dependencies-with-a-group-library)
...
### [Create a pre-built mergeable library](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#Create-a-pre-built-mergeable-library)
...
*   Create an XCFramework from an archive of your library. For more information, see [Creating a multiplatform binary framework bundle](/documentation/xcode/creating-a-multi-platform-binary-framework-bundle).
...
To use your XCFramework that contains mergeable metadata, add it to the Link Binaries build phase of a target that you configured for automatic or manual merging. For more information, see [Link against additional frameworks and libraries](/documentation/xcode/customizing-the-build-phases-of-a-target#Link-against-additional-frameworks-and-libraries).

## [See Also](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#see-also)

### [Performance](/documentation/Xcode/configuring-your-project-to-use-mergeable-libraries#Performance)
