...
## [Overview](/documentation/Xcode/Creating-a-workflow-that-builds-your-app-for-distribution#Overview)
...
If you’re new to continuous integration and delivery (CI/CD), see [About continuous integration and delivery with Xcode Cloud](/documentation/xcode/about-continuous-integration-and-delivery-with-xcode-cloud). For more information on developing a workflow strategy, see [Developing a workflow strategy for Xcode Cloud](/documentation/xcode/developing-a-workflow-strategy-for-xcode-cloud).

### [Configure the workflow](/documentation/Xcode/Creating-a-workflow-that-builds-your-app-for-distribution#Configure-the-workflow)
...
*   In the Environments settings of the workflow, select Clean to configure the workflow so it starts builds without cached data. For more information, see [Perform a clean build](/documentation/xcode/xcode-cloud-workflow-reference#Perform-a-clean-build).
...
*   Add a post-action to notarize a macOS app if you intend to distribute it through your own channels. This sends the archive to the notary service to generate a ticket and staples the ticket to the archive. For more information, see [Notarizing macOS software before distribution](/documentation/Security/notarizing-macos-software-before-distribution).
    
*   Download and archive build artifacts after a completed build as described in [Download and archive build artifacts](/documentation/xcode/configuring-your-first-xcode-cloud-workflow#Download-and-archive-build-artifacts).
...
## [See Also](/documentation/Xcode/Creating-a-workflow-that-builds-your-app-for-distribution#see-also)

### [Workflows](/documentation/Xcode/Creating-a-workflow-that-builds-your-app-for-distribution#Workflows)
