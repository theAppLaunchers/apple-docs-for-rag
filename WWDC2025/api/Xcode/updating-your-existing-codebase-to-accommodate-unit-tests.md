...
## [Overview](/documentation/Xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Overview)
...
### [Replace a concrete type with a protocol](/documentation/Xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Replace-a-concrete-type-with-a-protocol)
...
### [Replace named type with metatype value](/documentation/Xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Replace-named-type-with-metatype-value)
...
### [Inject a singleton](/documentation/Xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Inject-a-singleton)
...
Commonly-used singletons, including [`NSApplication`](/documentation/AppKit/NSApplication) and the default [`FileManager`](/documentation/Foundation/FileManager), have behavior that’s dependent on external state. Components that use these singletons directly introduce more complications for reliable testing.
...
You may need to combine this change with those described in the article sections ([Replace a concrete type with a protocol](/documentation/xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Replace-a-concrete-type-with-a-protocol) and [Subclass and override untestable methods](/documentation/xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Subclass-and-override-untestable-methods)) to create the alternative object you use in the test in place of the singleton. You’ll need to do this where the singleton supplies behavior that’s difficult to control in a test, like [`FileManager`](/documentation/Foundation/FileManager) or [`NSApplication`](/documentation/AppKit/NSApplication).

## [See Also](/documentation/Xcode/updating-your-existing-codebase-to-accommodate-unit-tests#see-also)

### [Test development](/documentation/Xcode/updating-your-existing-codebase-to-accommodate-unit-tests#Test-development)
