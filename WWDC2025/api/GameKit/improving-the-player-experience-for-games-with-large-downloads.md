...
## [Overview](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#overview)
...
### [Maximize your app bundle’s size](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Maximize-your-app-bundles-size)
...
### [Include additional content in your game’s base installation](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Include-additional-content-in-your-games-base-installation)
...
### [Apply tags to use on-demand resources](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Apply-tags-to-use-on-demand-resources)
...
### [Identify which tags apply to essential and early-game content](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Identify-which-tags-apply-to-essential-and-early-game-content)
...
### [Use the on-demand resources API for later-game and optional content](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Use-the-on-demand-resources-API-for-later-game-and-optional-content)

Your game can programmatically download asset packs using the [`NSBundleResourceRequest`](/documentation/Foundation/NSBundleResourceRequest) API. This allows you to save disk space by only downloading content after the player unlocks it through progression or In-App Purchases. Because asset packs can have multiple tags, splitting your content into smaller asset packs can further reduce your game’s disk space usage. Use the [`NSBundleResourceRequest`](/documentation/Foundation/NSBundleResourceRequest) API to request tags, which prompt the system to download any matching asset packs as necessary.

For content unlocked by progress, requesting tags before they’re needed can make the content available to the player without waiting. In case the download doesn’t complete before the player needs the content, use the [`progress`](/documentation/Foundation/NSBundleResourceRequest/progress) property to keep the user informed.

When the player completes part of your game’s content, use the [`setPreservationPriority(_:forTags:)`](/documentation/Foundation/Bundle/setPreservationPriority\(_:forTags:\)) method of the [`Bundle`](/documentation/Foundation/Bundle) class to inform the system that the asset packs containing that content are no longer necessary.

### [Stay within the on-demand resources limits](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Stay-within-the-on-demand-resources-limits)
...
Size prior to iOS 17, iPadOS 17, and tvOS 17

Size when targeting iOS 17, iPadOS 17, or tvOS 17

Size when targeting iOS 18, iPadOS 18, or tvOS 18
...
Initial install and prefetch tags
...
### [Use Background Assets for content outside the App Store](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Use-Background-Assets-for-content-outside-the-App-Store)

Use the [Background Assets](/documentation/BackgroundAssets) framework if you want to host your game’s additional content outside the App Store. To use Background Assets, write a Background Assets extension that tells the system how to download assets from your website or CDN. Your extension can also react to authentication challenges and changes in download status. Your game uses the [`BADownloadManager`](/documentation/BackgroundAssets/BADownloadManager) API to stay informed of completed downloads and schedule new downloads.
...
### [Add information about your essential content](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Add-information-about-your-essential-content)
...
### [Redownload essential assets on failure](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Redownload-essential-assets-on-failure)
...
## [See Also](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#see-also)

### [Essentials](/documentation/GameKit/improving-the-player-experience-for-games-with-large-downloads#Essentials)
