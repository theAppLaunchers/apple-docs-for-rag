...
## [Overview](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#Overview)
...
### [Create spatial photos and videos from your own media](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#Create-spatial-photos-and-videos-from-your-own-media)
...
Spatial photos and videos both use the same spatial metadata, but encode it in different ways. For examples of how to write spatial metadata to stereo photos and videos your app creates, check out [Writing spatial photos](/documentation/imageio/writing-spatial-photos) and [Converting side-by-side 3D video to multiview HEVC and spatial video](/documentation/AVFoundation/converting-side-by-side-3d-video-to-multiview-hevc-and-spatial-video).

### [Specify camera properties](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#Specify-camera-properties)
...
### [Choose a horizontal disparity adjustment](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#Choose-a-horizontal-disparity-adjustment)
...
### [Decide when to create spatial media](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#Decide-when-to-create-spatial-media)
...
## [See Also](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#see-also)

### [Spatial Photos](/documentation/ImageIO/Creating-spatial-photos-and-videos-with-spatial-metadata#Spatial-Photos)
