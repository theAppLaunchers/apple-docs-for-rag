...
[Download](https://docs-assets.developer.apple.com/published/18de717aedac/ImplementingWalletExtensions.zip)

iOS 14.0+iPadOS 14.0+Mac Catalyst 14.0+Xcode 15.0+

## [Overview](/documentation/PassKit/implementing-wallet-extensions#Overview)
...
### [Configure the sample code project](/documentation/PassKit/implementing-wallet-extensions#Configure-the-sample-code-project)
...
## [See Also](/documentation/PassKit/implementing-wallet-extensions#see-also)

### [Extend Wallet to add issuer cards](/documentation/PassKit/implementing-wallet-extensions#Extend-Wallet-to-add-issuer-cards)
