...
## [Overview](/documentation/StoreKit/testing-win-back-offers-in-xcode#overview)
...
Testing win-back offers in Xcode is convenient early in the development process, because it doesn’t rely on any product configurations in App Store Connect. However, you can also test win-back offers in the sandbox environment, which does rely on your App Store Connect configuration. For more information, see [Testing win-back offers in the sandbox environment](/documentation/storekit/testing-win-back-offers-in-the-sandbox-environment).

### [Perform basic setup](/documentation/StoreKit/testing-win-back-offers-in-xcode#Perform-basic-setup)

Before you can begin testing in Xcode, complete the steps in [Setting up StoreKit Testing in Xcode](/documentation/Xcode/setting-up-storekit-testing-in-xcode), including creating a StoreKit configuration file and enabling StoreKit testing in Xcode.

### [Configure win-back offers for testing](/documentation/StoreKit/testing-win-back-offers-in-xcode#Configure-win-back-offers-for-testing)
...
The payment mode of the offer. For more information, see [`Product.SubscriptionOffer.PaymentMode`](/documentation/storekit/product/subscriptionoffer/paymentmode-swift.struct).
...
### [Run the test](/documentation/StoreKit/testing-win-back-offers-in-xcode#Run-the-test)
...
5.  In your app, open your store. Examine your app’s implementation of the win-back offer. For example, if your app uses [StoreKit views](/documentation/storekit/storekit-views), the eligible offers appear automatically when your app displays a [`SubscriptionStoreView`](/documentation/storekit/subscriptionstoreview).
    

For more information about using the transaction manager, see [Testing in-app purchases with StoreKit transaction manager in Xcode](/documentation/Xcode/testing-in-app-purchases-with-storeKit-transaction-manager-in-code).

### [Reset or rerun the test](/documentation/StoreKit/testing-win-back-offers-in-xcode#Reset-or-rerun-the-test)
...
## [See Also](/documentation/StoreKit/testing-win-back-offers-in-xcode#see-also)

### [In-App Purchase Testing](/documentation/StoreKit/testing-win-back-offers-in-xcode#In-App-Purchase-Testing)
