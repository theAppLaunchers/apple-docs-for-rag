...
iOS 15.0+iPadOS 15.0+macOS 11.0+Xcode 13.0+
...
Apps that use Local Push Connectivity require the App Push Provider entitlement.
...
All cellular networks other than Band 48 CBRS require the device to be supervised for `NEAppPushProvider` to run. For more information, see Supervision of Apple devices.
