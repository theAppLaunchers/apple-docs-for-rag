...
The JSObjectRef with the private data you want to set.
...
The default object class doesn’t allocate storage for private data. Only objects that have a non-`NULL` JSClassRef can store private data.
