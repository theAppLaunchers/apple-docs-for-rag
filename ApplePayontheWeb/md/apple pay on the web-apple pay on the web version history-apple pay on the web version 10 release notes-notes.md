...
- Added CSS support for rendering Apple Pay buttons using the `border-radius` property to enable custom corner radii. For more information, see Styling the Apple Pay Button Using CSS.

- Added support for billingContact in ApplePayPaymentMethod.

- Added support for new Apple Pay buttons including `add-money`, `contribute`, `order`, `reload`, `rent`, `support`, `tip`, and `top-up`. For more information, see Displaying Apple Pay Buttons Using CSS.
