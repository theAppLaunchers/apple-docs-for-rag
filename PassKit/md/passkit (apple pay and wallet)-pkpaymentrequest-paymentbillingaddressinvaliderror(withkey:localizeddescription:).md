...
``` source
class func paymentBillingAddressInvalidError(
...
You can use this convenience method to create a payment error object instead of creating an NSError object yourself. This method indicates an error in the billing address that is received from an Apple Pay sheet.
