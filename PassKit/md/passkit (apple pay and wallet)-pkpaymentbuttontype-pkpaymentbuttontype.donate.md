...
iOS 10.2+iPadOS 10.2+Mac Catalyst 13.1+macOS 11.0+visionOS 1.0+watchOS 3.2+
...
Approved nonprofits can use this button to accept donations. For design guidance, see Human Interface Guidelines > Apple Pay > Buttons and Marks.
