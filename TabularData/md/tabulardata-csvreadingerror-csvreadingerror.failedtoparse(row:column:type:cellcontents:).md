...
The index of the row that contains the invalid data.

`column`  

The index of the column that contains the invalid data.

`type`  

The type the CSV reader expects.

`cellContents`  

The data the CSV reader can’t parse.
