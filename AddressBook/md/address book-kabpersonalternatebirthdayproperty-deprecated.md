...
- Address Book
-  kABPersonAlternateBirthdayProperty Deprecated
...
You can use toll-free bridging to cast the value to NSDictionary. The data corresponds to an NSDateComponents object.
