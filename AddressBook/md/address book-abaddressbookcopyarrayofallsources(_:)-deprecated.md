...
- Address Book
-  ABAddressBookCopyArrayOfAllSources(\_:) Deprecated
...
``` source
func ABAddressBookCopyArrayOfAllSources(_ addressBook: ABAddressBook!) -> Unmanaged!
```

Deprecated

use \[CNContactStore containersMatchingPredicate:nil error:\]
