...
- Address Book
-  ABPersonCopyLocalizedPropertyName(\_:) Deprecated
...
``` source
func ABPersonCopyLocalizedPropertyName(_ property: ABPropertyID) -> Unmanaged!
```

Deprecated

use \[CNContact localizedStringForKey:\]
