...
- Address Book
-  ABAddressBookCopyDefaultSource(\_:) Deprecated
...
``` source
func ABAddressBookCopyDefaultSource(_ addressBook: ABAddressBook!) -> Unmanaged!
```

Deprecated

use \[CNContactStore containersMatchingPredicate:\[CNContainer predicateForContainersWithIdentifiers: @\[CNContactStore.defaultContainerIdentifier\]\] error:\]
