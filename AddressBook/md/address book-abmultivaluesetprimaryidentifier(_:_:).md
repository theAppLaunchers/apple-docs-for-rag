...
``` source
func ABMultiValueSetPrimaryIdentifier(
...
The identifier corresponding to the value you wish to designate as the primary value for this multi-value list. Use the ABMultiValueCopyIdentifierAtIndex(_:_:) function to get the identifier given the index. If `identifier` is `NULL`, this function raises an exception.
