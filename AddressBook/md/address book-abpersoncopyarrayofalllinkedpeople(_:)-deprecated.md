...
- Address Book
-  ABPersonCopyArrayOfAllLinkedPeople(\_:) Deprecated
...
``` source
func ABPersonCopyArrayOfAllLinkedPeople(_ person: ABRecord!) -> Unmanaged!
```

Deprecated

use CNContactFetchRequest with predicate = \[CNContact predicateForContactsLinkedToContact:\] and unifyResults = NO
