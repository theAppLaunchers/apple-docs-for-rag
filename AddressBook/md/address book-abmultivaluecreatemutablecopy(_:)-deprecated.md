...
- Address Book
-  ABMultiValueCreateMutableCopy(\_:) Deprecated
...
``` source
func ABMultiValueCreateMutableCopy(_ multiValue: ABMultiValue!) -> Unmanaged!
```

**macOS**

``` source
func ABMultiValueCreateMutableCopy(_ multiValue: ABMultiValueRef!) -> Unmanaged!
```
