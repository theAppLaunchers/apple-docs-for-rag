...
- Address Book
-  ABPersonCopySource(\_:) Deprecated
...
``` source
func ABPersonCopySource(_ person: ABRecord!) -> Unmanaged!
```

Deprecated

use \[CNContactStore containersMatchingPredicate:\[CNContainer predicateForContainerOfContactWithIdentifier:\] error:\]
