...
- Address Book
-  ABAddressBookCopyArrayOfAllGroupsInSource(\_:\_:) Deprecated
...
``` source
func ABAddressBookCopyArrayOfAllGroupsInSource(
...
use \[CNContactStore groupsMatchingPredicate:\[CNGroup predicateForGroupsInContainerWithIdentifier:\] error:\]
