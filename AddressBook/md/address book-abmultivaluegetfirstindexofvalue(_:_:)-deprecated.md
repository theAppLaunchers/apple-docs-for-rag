...
- Address Book
-  ABMultiValueGetFirstIndexOfValue(\_:\_:) Deprecated
...
``` source
func ABMultiValueGetFirstIndexOfValue(
...
use \[NSArray indexOfObjectPassingTest:\] with the labeled value property and find the value
