...
- Address Book
-  ABAddressBookCopyArrayOfAllPeople(\_:) Deprecated
...
``` source
func ABAddressBookCopyArrayOfAllPeople(_ addressBook: ABAddressBook!) -> Unmanaged!
```

Deprecated

use CNContactFetchRequest with predicate = nil
