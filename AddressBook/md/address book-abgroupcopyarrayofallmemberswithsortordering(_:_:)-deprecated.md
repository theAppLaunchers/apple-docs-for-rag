...
- Address Book
-  ABGroupCopyArrayOfAllMembersWithSortOrdering(\_:\_:) Deprecated
...
``` source
func ABGroupCopyArrayOfAllMembersWithSortOrdering(
    _ group: ABRecord!,
...
use CNContactFetchRequest with predicate = \[CNContact predicateForContactsInGroupWithIdentifier:\] and sortOrder
