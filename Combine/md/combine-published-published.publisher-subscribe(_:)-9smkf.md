...
Always call this function instead of receive(subscriber:). Adopters of Published.Publisher must implement receive(subscriber:). The implementation of subscribe(_:) provided by Published.Publisher calls through to receive(subscriber:).
