...
) async throws -> (modificationResultsByID: [CKRecord.ID : Result], deletions: [CKDatabase.RecordZoneChange.Deletion], changeToken: CKServerChangeToken, moreComing: Bool)
```
