...
This variable indicates if the application shows or hides the service. The corresponding value is one of the constants in the HMCharacteristicValueCurrentVisibilityState enumeration.
