...
This variable indicates if applications show or hide the service. The corresponding value is one of the constants in the HMCharacteristicValueCurrentVisibilityState enumeration.
