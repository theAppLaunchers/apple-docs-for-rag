...
This value is a 2-byte sequence in host byte order. See tls_protocol_version_t for possible values. If the task didn’t negotiate an encrypted connection, this value is `nil`.
