...
If you specify a malformed URL or the referenced location doesn’t exist on disk, the initializer fails and returns nil. To handle such errors, use init(contentsOfURL:options:) instead.
