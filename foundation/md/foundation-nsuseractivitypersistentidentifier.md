...
In Objective-C, NSUserActivity persistent identifiers are a type alias of NSString. In Swift, NSUserActivity persistent identifiers use the NSUserActivityPersistentIdentifier structure.
