...
When working with text that’s presented to the user, use the localizedStringWithFormat: method, or the initWithFormat:locale: or init(format:locale:arguments:) method, passing current as the locale.
