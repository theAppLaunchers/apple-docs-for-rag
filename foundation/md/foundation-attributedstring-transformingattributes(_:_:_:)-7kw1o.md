...
func transformingAttributes(
    _ k: K1.Type,
    _ k2: K2.Type,
    _ c: (inout AttributedString.SingleAttributeTransformer, inout AttributedString.SingleAttributeTransformer) -> Void
) -> AttributedString where K1 : AttributedStringKey, K2 : AttributedStringKey, K1.Value : Sendable, K2.Value : Sendable
```
...
A closure that receives two AttributedString.SingleAttributeTransformer instances that you use to access and alter the attributes’ ranges and values.
