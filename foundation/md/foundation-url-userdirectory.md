...
This computed property is equivalent to calling NSSearchPathForDirectoriesInDomains(_:_:_:) with the FileManager.SearchPathDirectory.userDirectory parameter.
