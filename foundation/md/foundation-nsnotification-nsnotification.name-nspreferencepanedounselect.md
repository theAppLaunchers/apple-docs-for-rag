...
Posted when reply(toShouldUnselect:) is invoked with an argument of true after shouldUnselect has returned a value of NSPreferencePaneUnselectReply.unselectLater.
