...
The following example creates a default Decimal.FormatStyle for the `en_US` locale, and a second style that uses scientific notation style. It then applies each style to an array of decimal values.
