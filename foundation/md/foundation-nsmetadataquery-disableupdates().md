...
Unless you use enumerateResults(_:) or enumerateResults(options:using:), you should invoke this method before iterating over query results that could change due to live updates.
