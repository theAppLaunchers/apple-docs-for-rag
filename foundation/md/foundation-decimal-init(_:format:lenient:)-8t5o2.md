...
A format style that describes currency formatting conventions used by the string. The initializer uses this format’s `Decimal/FormatStyle/parseStrategy` to parse the string.
