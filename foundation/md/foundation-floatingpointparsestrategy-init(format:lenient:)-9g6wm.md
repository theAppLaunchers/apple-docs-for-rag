...
init(
    format: Format,
    lenient: Bool = true
) where Format == FloatingPointFormatStyle.Currency, Value : BinaryFloatingPoint
```
...
A configured FloatingPointFormatStyle.Currency that describes the currency string format to parse.
