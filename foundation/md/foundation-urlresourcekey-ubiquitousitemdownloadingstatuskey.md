...
The value indicates whether a local copy exists and whether that copy is the most current version of the item. See URLUbiquitousItemDownloadingStatus for values for this key.
