...
func CMIOStreamClockCreate(
    ...
    _ clockName: CFString!,
    _ sourceIdentifier: UnsafeRawPointer!,
    _ getTimeCallMinimumInterval: CMTime,
    _ numberOfEventsForRateSmoothing: UInt32,
    _ numberOfAveragesForRateSmoothing: UInt32,
    _ clock: UnsafeMutablePointer?>!
) -> OSStatus
```
