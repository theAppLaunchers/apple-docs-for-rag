...
The type of geometric primitive from which to construct the mesh; must be triangles.

`inwardNormals`  

true to generate normal vectors pointing toward the central axis of the cone; false to generate normal vectors pointing outward.
