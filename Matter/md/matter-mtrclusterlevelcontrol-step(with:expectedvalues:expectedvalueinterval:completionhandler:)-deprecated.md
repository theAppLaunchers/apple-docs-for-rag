...
-  step(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func step(
    with params: MTRLevelControlClusterStepParams,
...
Please use stepWithParams:expectedValues:expectedValueInterval:completion:
