...
- Matter
- MTRClusterDoorLock
-  getCredentialStatus(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func getCredentialStatus(
    ...
    completionHandler: @escaping (MTRDoorLockClusterGetCredentialStatusResponseParams?, (any Error)?) -> Void
)
```
...
func credentialStatus(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRDoorLockClusterGetCredentialStatusResponseParams
```
