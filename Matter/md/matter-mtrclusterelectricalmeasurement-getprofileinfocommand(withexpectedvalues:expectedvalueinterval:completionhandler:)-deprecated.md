...
-  getProfileInfoCommand(withExpectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use getProfileInfoCommandWithExpectedValues:expectedValueInterval:completion:
