...
-  readAttributeSampledPosition(withAttributeCache:endpoint:queue:completionHandler:) Deprecated
...
class func readAttributeSampledPosition(
    ...
    completionHandler: @escaping (MTRMediaPlaybackClusterPlaybackPosition?, (any Error)?) -> Void
)
```
...
class func readAttributeSampledPosition(
    ...
    endpoint: NSNumber,
    queue: dispatch_queue_t
) async throws -> MTRMediaPlaybackClusterPlaybackPosition
```
