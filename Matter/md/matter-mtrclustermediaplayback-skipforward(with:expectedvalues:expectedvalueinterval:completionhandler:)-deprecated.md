...
-  skipForward(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use skipForwardWithParams:expectedValues:expectedValueInterval:completion:
