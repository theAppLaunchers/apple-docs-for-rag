...
-  readAttributeBarrierCommandCloseEvents(completionHandler:) Deprecated
...
``` source
func readAttributeBarrierCommandCloseEvents(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
