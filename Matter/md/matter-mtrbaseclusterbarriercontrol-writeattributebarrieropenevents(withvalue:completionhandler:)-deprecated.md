...
-  writeAttributeBarrierOpenEvents(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeBarrierOpenEvents(
...
Please use writeAttributeBarrierOpenEventsWithValue:completion:
