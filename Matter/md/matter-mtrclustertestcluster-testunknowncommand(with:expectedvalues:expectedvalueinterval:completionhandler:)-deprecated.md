...
-  testUnknownCommand(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func testUnknownCommand(
    with params: MTRTestClusterClusterTestUnknownCommandParams?,
...
Please use testUnknownCommandWithParams:expectedValues:expectedValueInterval:completion:
