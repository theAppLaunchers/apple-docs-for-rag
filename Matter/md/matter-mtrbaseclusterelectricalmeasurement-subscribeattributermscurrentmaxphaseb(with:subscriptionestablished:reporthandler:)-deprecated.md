...
-  subscribeAttributeRmsCurrentMaxPhaseB(with:subscriptionEstablished:reportHandler:) Deprecated

Instance Method

# subscribeAttributeRmsCurrentMaxPhaseB(with:subscriptionEstablished:reportHandler:)
...
``` source
func subscribeAttributeRmsCurrentMaxPhaseB(
