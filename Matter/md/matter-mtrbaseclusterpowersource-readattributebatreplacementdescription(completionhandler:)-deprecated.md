...
-  readAttributeBatReplacementDescription(completionHandler:) Deprecated
...
``` source
func readAttributeBatReplacementDescription(completionHandler: @escaping (String?, (any Error)?) -> Void)
```
