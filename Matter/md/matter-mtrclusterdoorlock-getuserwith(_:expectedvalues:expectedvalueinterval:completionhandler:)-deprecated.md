...
- Matter
- MTRClusterDoorLock
-  getUserWith(\_:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func getUserWith(
    _ params: MTRDoorLockClusterGetUserParams,
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?,
    completionHandler: @escaping (MTRDoorLockClusterGetUserResponseParams?, (any Error)?) -> Void
)
```

``` source
func user(
    with params: MTRDoorLockClusterGetUserParams,
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRDoorLockClusterGetUserResponseParams
```
