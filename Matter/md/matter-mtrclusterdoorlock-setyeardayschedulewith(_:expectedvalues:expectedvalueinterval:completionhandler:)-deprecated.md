...
- Matter
- MTRClusterDoorLock
-  setYearDayScheduleWith(\_:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use setYearDayScheduleWithParams:expectedValues:expectedValueInterval:completion:
