...
-  readAttributeHarmonicCurrentMultiplier(completionHandler:) Deprecated
...
``` source
func readAttributeHarmonicCurrentMultiplier(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
