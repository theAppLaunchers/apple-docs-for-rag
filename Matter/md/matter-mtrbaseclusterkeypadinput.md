...
func sendKey(with: MTRKeypadInputClusterSendKeyParams, completion: (MTRKeypadInputClusterSendKeyResponseParams?, (any Error)?) -> Void)

func sendKey(with: MTRKeypadInputClusterSendKeyParams, completionHandler: (MTRKeypadInputClusterSendKeyResponseParams?, (any Error)?) -> Void)Deprecated
