...
-  test(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func test(
    with params: MTRTestClusterClusterTestParams?,
...
Please use testWithParams:expectedValues:expectedValueInterval:completion:
