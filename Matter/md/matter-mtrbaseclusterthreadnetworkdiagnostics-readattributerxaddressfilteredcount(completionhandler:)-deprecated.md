...
-  readAttributeRxAddressFilteredCount(completionHandler:) Deprecated
...
``` source
func readAttributeRxAddressFilteredCount(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
