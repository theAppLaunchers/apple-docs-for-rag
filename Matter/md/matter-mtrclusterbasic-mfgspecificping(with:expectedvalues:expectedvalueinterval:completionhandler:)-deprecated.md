...
- Matter
- MTRClusterBasic
-  mfgSpecificPing(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func mfgSpecificPing(
    with params: MTRBasicClusterMfgSpecificPingParams?,
