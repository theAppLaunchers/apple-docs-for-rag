...
-  subscribeAttributePacketUnicastTxCount(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePacketUnicastTxCount(
