...
-  writeAttributeNullableRangeRestrictedInt16s(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableRangeRestrictedInt16s(
...
Please use writeAttributeNullableRangeRestrictedInt16sWithValue:completion:
