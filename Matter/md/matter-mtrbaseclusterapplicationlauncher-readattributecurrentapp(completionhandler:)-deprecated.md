...
-  readAttributeCurrentApp(completionHandler:) Deprecated
...
``` source
func readAttributeCurrentApp(completionHandler: @escaping (MTRApplicationLauncherClusterApplicationEP?, (any Error)?) -> Void)
```
