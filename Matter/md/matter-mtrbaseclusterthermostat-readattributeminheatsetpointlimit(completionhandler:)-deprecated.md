...
-  readAttributeMinHeatSetpointLimit(completionHandler:) Deprecated
...
``` source
func readAttributeMinHeatSetpointLimit(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
