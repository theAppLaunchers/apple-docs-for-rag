...
-  subscribeAttributeMaxRFIDCodeLength(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeMaxRFIDCodeLength(
