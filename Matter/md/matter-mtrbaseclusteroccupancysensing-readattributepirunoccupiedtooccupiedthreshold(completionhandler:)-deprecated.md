...
-  readAttributePirUnoccupiedToOccupiedThreshold(completionHandler:) Deprecated
...
``` source
func readAttributePirUnoccupiedToOccupiedThreshold(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
