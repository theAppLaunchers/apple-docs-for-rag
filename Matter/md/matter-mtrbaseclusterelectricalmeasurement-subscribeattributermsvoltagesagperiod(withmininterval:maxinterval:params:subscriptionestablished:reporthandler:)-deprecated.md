...
-  subscribeAttributeRmsVoltageSagPeriod(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeRmsVoltageSagPeriod(
