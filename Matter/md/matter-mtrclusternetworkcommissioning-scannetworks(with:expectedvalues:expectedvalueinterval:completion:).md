...
-  scanNetworks(with:expectedValues:expectedValueInterval:completion:) 
...
func scanNetworks(
    ...
    completion: @escaping (MTRNetworkCommissioningClusterScanNetworksResponseParams?, (any Error)?) -> Void
)
```
