...
-  readAttributeUnoccupiedHeatingSetpoint(completionHandler:) Deprecated
...
``` source
func readAttributeUnoccupiedHeatingSetpoint(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
