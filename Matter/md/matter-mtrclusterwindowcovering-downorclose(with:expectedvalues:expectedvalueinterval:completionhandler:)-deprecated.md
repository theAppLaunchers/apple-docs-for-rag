...
-  downOrClose(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated

Instance Method

# downOrClose(with:expectedValues:expectedValueInterval:completionHandler:)
