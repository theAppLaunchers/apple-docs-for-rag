...
- Matter
- MTRClusterDoorLock
-  getWeekDaySchedule(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func getWeekDaySchedule(
    ...
    completionHandler: @escaping (MTRDoorLockClusterGetWeekDayScheduleResponseParams?, (any Error)?) -> Void
)
```
...
func weekDaySchedule(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRDoorLockClusterGetWeekDayScheduleResponseParams
```
