...
-  readAttributeStructAttr(completionHandler:) Deprecated
...
``` source
func readAttributeStructAttr(completionHandler: @escaping (MTRTestClusterClusterSimpleStruct?, (any Error)?) -> Void)
```
