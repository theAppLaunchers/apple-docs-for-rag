...
-  readAttributeInstantaneousLineCurrent(completionHandler:) Deprecated
...
``` source
func readAttributeInstantaneousLineCurrent(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
