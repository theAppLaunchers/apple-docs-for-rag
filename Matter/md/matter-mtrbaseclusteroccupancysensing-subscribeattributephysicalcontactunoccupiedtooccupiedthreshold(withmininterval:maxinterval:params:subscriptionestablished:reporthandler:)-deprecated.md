...
-  subscribeAttributePhysicalContactUnoccupiedToOccupiedThreshold(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePhysicalContactUnoccupiedToOccupiedThreshold(
