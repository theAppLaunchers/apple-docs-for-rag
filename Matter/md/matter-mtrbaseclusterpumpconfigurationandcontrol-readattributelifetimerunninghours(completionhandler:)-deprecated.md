...
-  readAttributeLifetimeRunningHours(completionHandler:) Deprecated
...
``` source
func readAttributeLifetimeRunningHours(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
