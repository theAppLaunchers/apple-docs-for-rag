...
-  subscribeAttributePowerMultiplier(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePowerMultiplier(
