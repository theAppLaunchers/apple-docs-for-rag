...
-  readAttributeLifetimeEnergyConsumed(completionHandler:) Deprecated
...
``` source
func readAttributeLifetimeEnergyConsumed(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
