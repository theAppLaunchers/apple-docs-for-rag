...
-  subscribeAttributeActivePowerMaxPhaseB(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeActivePowerMaxPhaseB(
