...
-  certificateChainRequest(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func certificateChainRequest(
    ...
    completionHandler: @escaping (MTROperationalCredentialsClusterCertificateChainResponseParams?, (any Error)?) -> Void
)
```
...
func certificateChainRequest(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTROperationalCredentialsClusterCertificateChainResponseParams
```
