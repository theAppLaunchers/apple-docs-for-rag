...
-  subscribeAttributePhysicalContactOccupiedToUnoccupiedDelay(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePhysicalContactOccupiedToUnoccupiedDelay(
