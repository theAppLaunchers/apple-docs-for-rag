...
-  subscribeAttributeCurrentFabricIndex(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeCurrentFabricIndex(
