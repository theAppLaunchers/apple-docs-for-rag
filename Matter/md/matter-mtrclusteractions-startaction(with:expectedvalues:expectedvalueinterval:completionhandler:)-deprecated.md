...
- Matter
- MTRClusterActions
-  startAction(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func startAction(
    with params: MTRActionsClusterStartActionParams,
...
Please use startActionWithParams:expectedValues:expectedValueInterval:completion:
