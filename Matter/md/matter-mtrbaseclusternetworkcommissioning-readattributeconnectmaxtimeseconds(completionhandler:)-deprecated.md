...
-  readAttributeConnectMaxTimeSeconds(completionHandler:) Deprecated
...
``` source
func readAttributeConnectMaxTimeSeconds(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
