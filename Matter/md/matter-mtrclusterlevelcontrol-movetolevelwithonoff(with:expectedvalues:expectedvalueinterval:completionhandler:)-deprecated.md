...
-  moveToLevelWithOnOff(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func moveToLevelWithOnOff(
    with params: MTRLevelControlClusterMoveToLevelWithOnOffParams,
