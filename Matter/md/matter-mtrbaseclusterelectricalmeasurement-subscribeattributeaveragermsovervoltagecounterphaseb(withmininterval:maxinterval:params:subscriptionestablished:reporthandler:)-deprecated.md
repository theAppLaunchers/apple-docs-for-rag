...
-  subscribeAttributeAverageRmsOverVoltageCounterPhaseB(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeAverageRmsOverVoltageCounterPhaseB(
