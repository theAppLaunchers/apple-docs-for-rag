...
-  readAttributeCurrentPositionLiftPercent100ths(completionHandler:) Deprecated
...
``` source
func readAttributeCurrentPositionLiftPercent100ths(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
