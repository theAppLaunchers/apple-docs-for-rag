...
-  readAttributeSubjectsPerAccessControlEntry(completionHandler:) Deprecated
...
``` source
func readAttributeSubjectsPerAccessControlEntry(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
