...
-  subscribeAttributeRmsExtremeUnderVoltage(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeRmsExtremeUnderVoltage(
...
Please use subscribeAttributeRmsExtremeUnderVoltageWithParams:subscriptionEstablished:
