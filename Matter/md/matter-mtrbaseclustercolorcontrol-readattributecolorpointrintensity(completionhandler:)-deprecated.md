...
-  readAttributeColorPointRIntensity(completionHandler:) Deprecated
...
``` source
func readAttributeColorPointRIntensity(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
