...
-  readAttributeRmsExtremeOverVoltagePeriodPhaseB(completion:) Deprecated
...
``` source
func readAttributeRmsExtremeOverVoltagePeriodPhaseB(completion: @escaping (NSNumber?, (any Error)?) -> Void)
```
