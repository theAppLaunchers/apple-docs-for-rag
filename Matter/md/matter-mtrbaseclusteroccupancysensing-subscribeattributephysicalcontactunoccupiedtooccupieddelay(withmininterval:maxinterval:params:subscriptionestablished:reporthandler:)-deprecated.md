...
-  subscribeAttributePhysicalContactUnoccupiedToOccupiedDelay(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePhysicalContactUnoccupiedToOccupiedDelay(
