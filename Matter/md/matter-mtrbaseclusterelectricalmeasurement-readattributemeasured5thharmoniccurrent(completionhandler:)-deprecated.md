...
-  readAttributeMeasured5thHarmonicCurrent(completionHandler:) Deprecated
...
``` source
func readAttributeMeasured5thHarmonicCurrent(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
