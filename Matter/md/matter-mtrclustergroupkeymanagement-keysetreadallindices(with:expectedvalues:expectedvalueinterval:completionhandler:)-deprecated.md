...
-  keySetReadAllIndices(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func keySetReadAllIndices(
    ...
    completionHandler: @escaping (MTRGroupKeyManagementClusterKeySetReadAllIndicesResponseParams?, (any Error)?) -> Void
)
```
