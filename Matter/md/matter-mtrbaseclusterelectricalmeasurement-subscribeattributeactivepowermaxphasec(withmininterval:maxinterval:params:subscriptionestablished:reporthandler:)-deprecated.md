...
-  subscribeAttributeActivePowerMaxPhaseC(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeActivePowerMaxPhaseC(
