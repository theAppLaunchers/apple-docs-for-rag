...
-  setRegulatoryConfigWith(\_:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use setRegulatoryConfigWithParams:expectedValues:expectedValueInterval:completion:
