...
-  testEnumsRequest(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func testEnumsRequest(
    with params: MTRTestClusterClusterTestEnumsRequestParams,
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?,
    completionHandler: @escaping (MTRTestClusterClusterTestEnumsResponseParams?, (any Error)?) -> Void
)
```
...
func testEnumsRequest(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRTestClusterClusterTestEnumsResponseParams
```
