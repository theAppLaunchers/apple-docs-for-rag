...
-  writeAttributeNullableCharString(withValue:params:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableCharString(
...
Please use writeAttributeNullableCharStringWithValue:params:completion:
