...
-  readAttributeRmsExtremeOverVoltagePeriodPhaseB(completionHandler:) Deprecated
...
``` source
func readAttributeRmsExtremeOverVoltagePeriodPhaseB(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
