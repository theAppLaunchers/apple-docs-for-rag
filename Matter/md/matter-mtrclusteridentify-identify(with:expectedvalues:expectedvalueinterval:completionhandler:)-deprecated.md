...
- Matter
- MTRClusterIdentify
-  identify(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func identify(
    with params: MTRIdentifyClusterIdentifyParams,
...
Please use identifyWithParams:expectedValues:expectedValueInterval:completion:
