...
-  subscribeAttributeACErrorCode(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
Please use subscribeAttributeACErrorCodeWithParams:subscriptionEstablished:
