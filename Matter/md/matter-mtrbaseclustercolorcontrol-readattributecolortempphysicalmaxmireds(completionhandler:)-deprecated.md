...
-  readAttributeColorTempPhysicalMaxMireds(completionHandler:) Deprecated
...
``` source
func readAttributeColorTempPhysicalMaxMireds(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
