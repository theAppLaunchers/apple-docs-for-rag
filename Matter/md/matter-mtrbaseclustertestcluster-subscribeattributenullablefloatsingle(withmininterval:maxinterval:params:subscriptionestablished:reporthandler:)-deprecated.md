...
-  subscribeAttributeNullableFloatSingle(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeNullableFloatSingle(
