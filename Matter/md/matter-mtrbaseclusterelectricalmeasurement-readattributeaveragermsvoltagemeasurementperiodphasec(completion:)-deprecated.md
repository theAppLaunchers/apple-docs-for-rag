...
-  readAttributeAverageRmsVoltageMeasurementPeriodPhaseC(completion:) Deprecated
...
``` source
func readAttributeAverageRmsVoltageMeasurementPeriodPhaseC(completion: @escaping (NSNumber?, (any Error)?) -> Void)
```
