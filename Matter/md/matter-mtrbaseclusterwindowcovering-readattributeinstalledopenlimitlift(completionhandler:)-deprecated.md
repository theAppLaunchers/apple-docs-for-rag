...
-  readAttributeInstalledOpenLimitLift(completionHandler:) Deprecated
...
``` source
func readAttributeInstalledOpenLimitLift(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
