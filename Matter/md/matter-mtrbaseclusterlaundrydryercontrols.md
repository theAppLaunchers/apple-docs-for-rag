...
func readAttributeSelectedDrynessLevel(completion: (NSNumber?, (any Error)?) -> Void)

func readAttributeSupportedDrynessLevels(completion: ([Any]?, (any Error)?) -> Void)
...
func subscribeAttributeSelectedDrynessLevel(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)

func subscribeAttributeSupportedDrynessLevels(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)

func writeAttributeSelectedDrynessLevel(withValue: NSNumber?, completion: MTRStatusCompletion)

func writeAttributeSelectedDrynessLevel(withValue: NSNumber?, params: MTRWriteParams?, completion: MTRStatusCompletion)
...
class func readAttributeSelectedDrynessLevel(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)

class func readAttributeSupportedDrynessLevels(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: ([Any]?, (any Error)?) -> Void)
