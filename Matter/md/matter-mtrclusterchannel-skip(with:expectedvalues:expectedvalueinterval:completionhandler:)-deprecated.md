...
- Matter
- MTRClusterChannel
-  skip(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func skip(
    with params: MTRChannelClusterSkipChannelParams,
...
Please use skipChannelWithParams:expectedValues:expectedValueInterval:completion:
