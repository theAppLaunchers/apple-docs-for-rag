...
func readAttributeTemperatureUnit(completion: (NSNumber?, (any Error)?) -> Void)

func readAttributeTemperatureUnit(completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated
...
func subscribeAttributeTemperatureUnit(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)

func subscribeAttributeTemperatureUnit(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

func writeAttributeTemperatureUnit(withValue: NSNumber, completion: MTRStatusCompletion)

func writeAttributeTemperatureUnit(withValue: NSNumber, completionHandler: MTRStatusCompletion)Deprecated

func writeAttributeTemperatureUnit(withValue: NSNumber, params: MTRWriteParams?, completion: MTRStatusCompletion)

func writeAttributeTemperatureUnit(withValue: NSNumber, params: MTRWriteParams?, completionHandler: MTRStatusCompletion)Deprecated
...
class func readAttributeTemperatureUnit(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

class func readAttributeTemperatureUnit(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)
