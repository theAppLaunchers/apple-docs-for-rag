...
func cancelRequest(with: MTRMessagesClusterCancelMessagesRequestParams, completion: MTRStatusCompletion)

Command CancelMessagesRequest

func presentRequest(with: MTRMessagesClusterPresentMessagesRequestParams, completion: MTRStatusCompletion)

Command PresentMessagesRequest

func readAttributeAcceptedCommandList(completion: ([Any]?, (any Error)?) -> Void)

func readAttributeActiveMessageIDs(completion: ([Any]?, (any Error)?) -> Void)
...
func readAttributeMessages(completion: ([Any]?, (any Error)?) -> Void)
...
func subscribeAttributeActiveMessageIDs(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)
...
func subscribeAttributeMessages(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)
...
class func readAttributeActiveMessageIDs(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: ([Any]?, (any Error)?) -> Void)
...
class func readAttributeMessages(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: ([Any]?, (any Error)?) -> Void)
