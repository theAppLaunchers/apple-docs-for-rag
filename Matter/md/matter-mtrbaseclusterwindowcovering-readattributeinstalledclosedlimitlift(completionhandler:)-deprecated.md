...
-  readAttributeInstalledClosedLimitLift(completionHandler:) Deprecated
...
``` source
func readAttributeInstalledClosedLimitLift(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
