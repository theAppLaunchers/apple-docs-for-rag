...
-  openWindow(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func openWindow(
    with params: MTRAdministratorCommissioningClusterOpenCommissioningWindowParams,
