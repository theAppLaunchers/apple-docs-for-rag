...
-  subscribeAttributeApplicationType(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeApplicationType(
