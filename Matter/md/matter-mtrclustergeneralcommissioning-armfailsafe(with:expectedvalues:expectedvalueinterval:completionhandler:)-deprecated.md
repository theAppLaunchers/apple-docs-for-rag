...
-  armFailSafe(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func armFailSafe(
    ...
    completionHandler: @escaping (MTRGeneralCommissioningClusterArmFailSafeResponseParams?, (any Error)?) -> Void
)
```
...
Please use armFailSafeWithParams:expectedValues:expectedValueInterval:completion:
