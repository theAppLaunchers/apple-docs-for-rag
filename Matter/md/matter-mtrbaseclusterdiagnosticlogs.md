...
func retrieveLogsRequest(with: MTRDiagnosticLogsClusterRetrieveLogsRequestParams, completion: (MTRDiagnosticLogsClusterRetrieveLogsResponseParams?, (any Error)?) -> Void)

func retrieveLogsRequest(with: MTRDiagnosticLogsClusterRetrieveLogsRequestParams, completionHandler: (MTRDiagnosticLogsClusterRetrieveLogsResponseParams?, (any Error)?) -> Void)Deprecated
