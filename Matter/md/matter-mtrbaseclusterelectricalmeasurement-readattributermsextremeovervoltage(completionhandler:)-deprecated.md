...
-  readAttributeRmsExtremeOverVoltage(completionHandler:) Deprecated
...
``` source
func readAttributeRmsExtremeOverVoltage(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
