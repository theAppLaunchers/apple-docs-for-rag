...
-  subscribeAttributeAverageRmsVoltageMeasurementPeriodPhaseC(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeAverageRmsVoltageMeasurementPeriodPhaseC(
