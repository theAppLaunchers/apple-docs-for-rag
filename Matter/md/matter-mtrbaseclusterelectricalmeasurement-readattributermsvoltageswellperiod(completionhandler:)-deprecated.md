...
-  readAttributeRmsVoltageSwellPeriod(completionHandler:) Deprecated
...
``` source
func readAttributeRmsVoltageSwellPeriod(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
