...
-  readAttributeRangeRestrictedInt16u(completionHandler:) Deprecated
...
``` source
func readAttributeRangeRestrictedInt16u(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
