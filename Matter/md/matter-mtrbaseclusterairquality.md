...
func readAttributeAirQuality(completion: (NSNumber?, (any Error)?) -> Void)
...
func subscribeAttributeAirQuality(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)
...
class func readAttributeAirQuality(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)
