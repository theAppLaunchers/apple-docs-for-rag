...
-  subscribeAttributeNullableEnumAttr(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeNullableEnumAttr(
