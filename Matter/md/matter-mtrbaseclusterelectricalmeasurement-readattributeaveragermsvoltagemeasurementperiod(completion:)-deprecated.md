...
-  readAttributeAverageRmsVoltageMeasurementPeriod(completion:) Deprecated
...
``` source
func readAttributeAverageRmsVoltageMeasurementPeriod(completion: @escaping (NSNumber?, (any Error)?) -> Void)
```
