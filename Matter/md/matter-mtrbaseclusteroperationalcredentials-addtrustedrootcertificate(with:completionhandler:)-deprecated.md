...
-  addTrustedRootCertificate(with:completionHandler:) Deprecated
...
``` source
func addTrustedRootCertificate(
    with params: MTROperationalCredentialsClusterAddTrustedRootCertificateParams,
...
Please use addTrustedRootCertificateWithParams:completion:
