...
-  subscribeAttributeNumberOfYearDaySchedulesSupportedPerUser(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeNumberOfYearDaySchedulesSupportedPerUser(
