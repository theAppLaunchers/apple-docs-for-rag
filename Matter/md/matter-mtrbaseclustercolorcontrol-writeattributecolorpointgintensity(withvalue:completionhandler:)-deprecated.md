...
-  writeAttributeColorPointGIntensity(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeColorPointGIntensity(
...
Please use writeAttributeColorPointGIntensityWithValue:completion:
