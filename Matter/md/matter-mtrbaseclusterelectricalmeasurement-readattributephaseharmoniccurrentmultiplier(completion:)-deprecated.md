...
-  readAttributePhaseHarmonicCurrentMultiplier(completion:) Deprecated
...
``` source
func readAttributePhaseHarmonicCurrentMultiplier(completion: @escaping (NSNumber?, (any Error)?) -> Void)
```
