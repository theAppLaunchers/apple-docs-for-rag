...
-  readAttributeSetpointChangeSourceTimestamp(completionHandler:) Deprecated
...
``` source
func readAttributeSetpointChangeSourceTimestamp(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
