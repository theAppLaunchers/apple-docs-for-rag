...
-  readAttributeCurrentApp(withAttributeCache:endpoint:queue:completionHandler:) Deprecated
...
``` source
class func readAttributeCurrentApp(
    withAttributeCache attributeCacheContainer: MTRAttributeCacheContainer,
    endpoint: NSNumber,
    queue: dispatch_queue_t,
    completionHandler: @escaping (MTRApplicationLauncherClusterApplicationEP?, (any Error)?) -> Void
)
```
...
class func readAttributeCurrentApp(
    ...
    endpoint: NSNumber,
    queue: dispatch_queue_t
) async throws -> MTRApplicationLauncherClusterApplicationEP
```

Deprecated

Please use readAttributeCurrentAppWithAttributeCache:endpoint:queue:completion:
