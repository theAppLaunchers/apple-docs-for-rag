...
-  downOrClose(withExpectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use downOrCloseWithExpectedValues:expectedValueInterval:completion:
