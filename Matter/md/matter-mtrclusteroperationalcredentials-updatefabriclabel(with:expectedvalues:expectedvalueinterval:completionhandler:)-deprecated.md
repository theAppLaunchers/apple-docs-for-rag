...
-  updateFabricLabel(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func updateFabricLabel(
    with params: MTROperationalCredentialsClusterUpdateFabricLabelParams,
