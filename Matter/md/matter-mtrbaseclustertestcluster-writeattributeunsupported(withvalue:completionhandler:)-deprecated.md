...
-  writeAttributeUnsupported(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeUnsupported(
...
Please use writeAttributeUnsupportedWithValue:completion:
