...
-  testNullableOptionalRequest(completionHandler:) Deprecated
...
``` source
func testNullableOptionalRequest(completionHandler: @escaping (MTRTestClusterClusterTestNullableOptionalResponseParams?, (any Error)?) -> Void)
```
