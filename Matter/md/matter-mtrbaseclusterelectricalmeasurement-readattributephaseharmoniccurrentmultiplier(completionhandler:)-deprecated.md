...
-  readAttributePhaseHarmonicCurrentMultiplier(completionHandler:) Deprecated
...
``` source
func readAttributePhaseHarmonicCurrentMultiplier(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
