...
-  readAttributeCurrentChannel(completionHandler:) Deprecated
...
``` source
func readAttributeCurrentChannel(completionHandler: @escaping (MTRChannelClusterChannelInfo?, (any Error)?) -> Void)
```
