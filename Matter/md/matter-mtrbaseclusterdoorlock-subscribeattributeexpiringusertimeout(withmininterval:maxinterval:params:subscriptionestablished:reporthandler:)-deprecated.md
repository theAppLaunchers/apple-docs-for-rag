...
-  subscribeAttributeExpiringUserTimeout(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeExpiringUserTimeout(
