...
-  simpleStructEchoRequest(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func simpleStructEchoRequest(
    ...
    completionHandler: @escaping (MTRTestClusterClusterSimpleStructResponseParams?, (any Error)?) -> Void
)
```
...
func simpleStructEchoRequest(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRTestClusterClusterSimpleStructResponseParams
```
