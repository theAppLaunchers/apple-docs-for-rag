...
func readAttributeLabelList(completion: ([Any]?, (any Error)?) -> Void)

func readAttributeLabelList(completionHandler: ([Any]?, (any Error)?) -> Void)Deprecated
...
func subscribeAttributeLabelList(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)

func subscribeAttributeLabelList(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)Deprecated

func writeAttributeLabelList(withValue: [Any], completion: MTRStatusCompletion)

func writeAttributeLabelList(withValue: [Any], completionHandler: MTRStatusCompletion)Deprecated

func writeAttributeLabelList(withValue: [Any], params: MTRWriteParams?, completion: MTRStatusCompletion)

func writeAttributeLabelList(withValue: [Any], params: MTRWriteParams?, completionHandler: MTRStatusCompletion)Deprecated
...
class func readAttributeLabelList(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: ([Any]?, (any Error)?) -> Void)Deprecated

class func readAttributeLabelList(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: ([Any]?, (any Error)?) -> Void)
