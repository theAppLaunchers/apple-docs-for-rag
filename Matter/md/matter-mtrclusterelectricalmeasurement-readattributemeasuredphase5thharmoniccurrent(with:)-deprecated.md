...
-  readAttributeMeasuredPhase5thHarmonicCurrent(with:) Deprecated

Instance Method

# readAttributeMeasuredPhase5thHarmonicCurrent(with:)
...
``` source
func readAttributeMeasuredPhase5thHarmonicCurrent(with params: MTRReadParams?) -> [String : Any]?
```
