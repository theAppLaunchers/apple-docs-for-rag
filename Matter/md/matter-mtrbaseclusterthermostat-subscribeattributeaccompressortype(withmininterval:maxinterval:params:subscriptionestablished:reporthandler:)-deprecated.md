...
-  subscribeAttributeACCompressorType(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeACCompressorType(
