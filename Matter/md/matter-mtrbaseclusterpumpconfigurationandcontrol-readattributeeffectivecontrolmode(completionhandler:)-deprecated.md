...
-  readAttributeEffectiveControlMode(completionHandler:) Deprecated
...
``` source
func readAttributeEffectiveControlMode(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
