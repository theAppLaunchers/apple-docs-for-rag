...
-  subscribeAttributeOccupiedSetbackMax(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeOccupiedSetbackMax(
