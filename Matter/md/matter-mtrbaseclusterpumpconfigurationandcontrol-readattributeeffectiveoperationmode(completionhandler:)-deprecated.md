...
-  readAttributeEffectiveOperationMode(completionHandler:) Deprecated
...
``` source
func readAttributeEffectiveOperationMode(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
