...
-  stopWithOnOff(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func stopWithOnOff(
    with params: MTRLevelControlClusterStopWithOnOffParams,
...
Please use stopWithOnOffWithParams:expectedValues:expectedValueInterval:completion:
