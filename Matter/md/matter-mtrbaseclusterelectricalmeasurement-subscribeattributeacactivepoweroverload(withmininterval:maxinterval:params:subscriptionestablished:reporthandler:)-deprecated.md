...
-  subscribeAttributeAcActivePowerOverload(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeAcActivePowerOverload(
