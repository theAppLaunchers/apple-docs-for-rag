...
-  readAttributeUnoccupiedCoolingSetpoint(completionHandler:) Deprecated
...
``` source
func readAttributeUnoccupiedCoolingSetpoint(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
