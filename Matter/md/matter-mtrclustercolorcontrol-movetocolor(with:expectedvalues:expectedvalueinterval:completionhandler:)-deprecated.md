...
-  moveToColor(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func moveToColor(
    with params: MTRColorControlClusterMoveToColorParams,
...
Please use moveToColorWithParams:expectedValues:expectedValueInterval:completion:
