...
-  subscribeAttributeRxErrUnknownNeighborCount(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeRxErrUnknownNeighborCount(
