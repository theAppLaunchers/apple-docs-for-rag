...
-  writeAttributeDefaultMoveRate(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeDefaultMoveRate(
...
Please use writeAttributeDefaultMoveRateWithValue:completion:
