...
-  subscribeAttributeMeasured11thHarmonicCurrent(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeMeasured11thHarmonicCurrent(
