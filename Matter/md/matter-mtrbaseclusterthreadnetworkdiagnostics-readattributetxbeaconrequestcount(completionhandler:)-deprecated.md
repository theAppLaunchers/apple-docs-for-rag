...
-  readAttributeTxBeaconRequestCount(completionHandler:) Deprecated
...
``` source
func readAttributeTxBeaconRequestCount(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
