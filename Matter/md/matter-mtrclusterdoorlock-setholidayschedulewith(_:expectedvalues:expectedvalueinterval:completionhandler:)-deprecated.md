...
- Matter
- MTRClusterDoorLock
-  setHolidayScheduleWith(\_:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func setHolidayScheduleWith(
    _ params: MTRDoorLockClusterSetHolidayScheduleParams,
