...
-  writeAttributeNullableInt32s(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableInt32s(
...
Please use writeAttributeNullableInt32sWithValue:completion:
