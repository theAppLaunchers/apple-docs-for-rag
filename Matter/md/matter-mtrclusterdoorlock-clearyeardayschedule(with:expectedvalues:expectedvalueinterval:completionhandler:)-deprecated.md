...
- Matter
- MTRClusterDoorLock
-  clearYearDaySchedule(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use clearYearDayScheduleWithParams:expectedValues:expectedValueInterval:completion:
