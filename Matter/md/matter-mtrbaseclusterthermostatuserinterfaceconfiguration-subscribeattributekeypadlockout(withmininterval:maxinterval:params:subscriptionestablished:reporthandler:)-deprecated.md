...
-  subscribeAttributeKeypadLockout(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeKeypadLockout(
