...
-  testAddArguments(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func testAddArguments(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRTestClusterClusterTestAddArgumentsResponseParams
```
