...
-  readAttributeListNullablesAndOptionalsStruct(completionHandler:) Deprecated
...
``` source
func readAttributeListNullablesAndOptionalsStruct(completionHandler: @escaping ([Any]?, (any Error)?) -> Void)
```
