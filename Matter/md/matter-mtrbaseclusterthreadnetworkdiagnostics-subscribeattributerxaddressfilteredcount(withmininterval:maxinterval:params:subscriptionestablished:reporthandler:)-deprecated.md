...
-  subscribeAttributeRxAddressFilteredCount(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeRxAddressFilteredCount(
