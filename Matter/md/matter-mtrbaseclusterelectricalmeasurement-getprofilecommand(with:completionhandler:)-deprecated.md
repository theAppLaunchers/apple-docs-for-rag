...
-  getProfileCommand(with:completionHandler:) Deprecated
...
``` source
func getProfileCommand(
    with params: MTRElectricalMeasurementClusterGetMeasurementProfileCommandParams,
...
Please use getMeasurementProfileCommandWithParams:completion:
