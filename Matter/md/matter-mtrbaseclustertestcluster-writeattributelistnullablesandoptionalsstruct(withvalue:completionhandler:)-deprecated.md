...
-  writeAttributeListNullablesAndOptionalsStruct(withValue:completionHandler:) Deprecated
...
Please use writeAttributeListNullablesAndOptionalsStructWithValue:completion:
