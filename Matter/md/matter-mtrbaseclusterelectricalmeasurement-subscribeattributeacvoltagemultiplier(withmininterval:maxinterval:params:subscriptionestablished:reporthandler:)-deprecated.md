...
-  subscribeAttributeAcVoltageMultiplier(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeAcVoltageMultiplier(
