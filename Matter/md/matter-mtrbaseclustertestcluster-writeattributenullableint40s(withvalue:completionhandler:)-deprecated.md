...
-  writeAttributeNullableInt40s(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableInt40s(
...
Please use writeAttributeNullableInt40sWithValue:completion:
