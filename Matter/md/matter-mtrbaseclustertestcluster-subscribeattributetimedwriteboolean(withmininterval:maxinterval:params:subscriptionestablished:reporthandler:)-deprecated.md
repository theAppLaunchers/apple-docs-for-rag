...
-  subscribeAttributeTimedWriteBoolean(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeTimedWriteBoolean(
