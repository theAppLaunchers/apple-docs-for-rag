...
-  subscribeAttributeNullableInt48s(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeNullableInt48s(
