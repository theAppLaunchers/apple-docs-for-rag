...
-  clearWeeklySchedule(withExpectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use clearWeeklyScheduleWithExpectedValues:expectedValueInterval:completion:
