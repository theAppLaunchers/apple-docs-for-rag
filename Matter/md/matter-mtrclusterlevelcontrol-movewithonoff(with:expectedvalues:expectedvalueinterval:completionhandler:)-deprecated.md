...
-  moveWithOnOff(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func moveWithOnOff(
    with params: MTRLevelControlClusterMoveWithOnOffParams,
...
Please use moveWithOnOffWithParams:expectedValues:expectedValueInterval:completion:
