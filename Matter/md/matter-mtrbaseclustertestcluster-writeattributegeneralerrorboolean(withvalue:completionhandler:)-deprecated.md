...
-  writeAttributeGeneralErrorBoolean(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeGeneralErrorBoolean(
...
Please use writeAttributeGeneralErrorBooleanWithValue:completion:
