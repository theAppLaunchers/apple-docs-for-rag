...
-  writeAttributeLongOctetString(withValue:params:completionHandler:) Deprecated
...
``` source
func writeAttributeLongOctetString(
...
Please use writeAttributeLongOctetStringWithValue:params:completion:
