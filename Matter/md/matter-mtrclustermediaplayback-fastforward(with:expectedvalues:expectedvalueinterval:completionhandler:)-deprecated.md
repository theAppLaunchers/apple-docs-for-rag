...
-  fastForward(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func fastForward(
    with params: MTRMediaPlaybackClusterFastForwardParams?,
...
Please use fastForwardWithParams:expectedValues:expectedValueInterval:completion:
