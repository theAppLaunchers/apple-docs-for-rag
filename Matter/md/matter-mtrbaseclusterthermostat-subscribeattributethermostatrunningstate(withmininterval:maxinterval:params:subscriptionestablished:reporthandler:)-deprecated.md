...
-  subscribeAttributeThermostatRunningState(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeThermostatRunningState(
