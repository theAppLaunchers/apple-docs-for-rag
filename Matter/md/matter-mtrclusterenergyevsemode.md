...
func changeToMode(with: MTREnergyEVSEModeClusterChangeToModeParams, expectedValues: [[String : Any]]?, expectedValueInterval: NSNumber?, completion: (MTREnergyEVSEModeClusterChangeToModeResponseParams?, (any Error)?) -> Void)
