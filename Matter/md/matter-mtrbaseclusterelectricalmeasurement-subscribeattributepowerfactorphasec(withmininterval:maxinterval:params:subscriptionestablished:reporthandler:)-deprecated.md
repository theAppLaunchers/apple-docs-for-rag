...
-  subscribeAttributePowerFactorPhaseC(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePowerFactorPhaseC(
