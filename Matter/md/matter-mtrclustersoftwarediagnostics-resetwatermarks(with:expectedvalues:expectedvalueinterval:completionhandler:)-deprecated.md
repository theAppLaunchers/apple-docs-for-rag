...
-  resetWatermarks(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
func resetWatermarks(
    with params: MTRSoftwareDiagnosticsClusterResetWatermarksParams?,
...
Please use resetWatermarksWithParams:expectedValues:expectedValueInterval:completion:
