...
-  writeAttributeNullableInt48u(withValue:params:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableInt48u(
...
Please use writeAttributeNullableInt48uWithValue:params:completion:
