...
-  stopApp(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func stopApp(
    with params: MTRApplicationLauncherClusterStopAppParams?,
...
Please use stopAppWithParams:expectedValues:expectedValueInterval:completion:
