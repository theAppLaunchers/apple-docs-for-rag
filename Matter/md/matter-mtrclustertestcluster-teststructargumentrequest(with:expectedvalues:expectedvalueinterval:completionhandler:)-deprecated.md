...
-  testStructArgumentRequest(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func testStructArgumentRequest(
    with params: MTRTestClusterClusterTestStructArgumentRequestParams,
