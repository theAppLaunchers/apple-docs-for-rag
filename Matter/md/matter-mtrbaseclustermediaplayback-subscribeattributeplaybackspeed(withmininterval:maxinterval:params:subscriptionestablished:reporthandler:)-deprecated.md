...
-  subscribeAttributePlaybackSpeed(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributePlaybackSpeed(
