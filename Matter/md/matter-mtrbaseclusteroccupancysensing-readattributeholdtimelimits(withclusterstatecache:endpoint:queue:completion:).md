...
``` source
class func readAttributeHoldTimeLimits(
    withClusterStateCache clusterStateCacheContainer: MTRClusterStateCacheContainer,
    endpoint: NSNumber,
    queue: dispatch_queue_t,
    completion: @escaping (MTROccupancySensingClusterHoldTimeLimitsStruct?, (any Error)?) -> Void
)
```
...
class func readAttributeHoldTimeLimits(
    ...
    endpoint: NSNumber,
    queue: dispatch_queue_t
) async throws -> MTROccupancySensingClusterHoldTimeLimitsStruct
```
