...
-  subscribeAttributeAutoRelockTime(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeAutoRelockTime(
