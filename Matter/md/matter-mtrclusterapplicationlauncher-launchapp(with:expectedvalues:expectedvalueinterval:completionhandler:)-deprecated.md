...
-  launchApp(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use launchAppWithParams:expectedValues:expectedValueInterval:completion:
