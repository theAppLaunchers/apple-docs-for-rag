...
func openBasicCommissioningWindow(with: MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams, completion: MTRStatusCompletion)

func openBasicCommissioningWindow(with: MTRAdministratorCommissioningClusterOpenBasicCommissioningWindowParams, completionHandler: MTRStatusCompletion)Deprecated

func openWindow(with: MTRAdministratorCommissioningClusterOpenCommissioningWindowParams, completion: MTRStatusCompletion)

func openWindow(with: MTRAdministratorCommissioningClusterOpenCommissioningWindowParams, completionHandler: MTRStatusCompletion)Deprecated
...
func readAttributeAdminFabricIndex(completion: (NSNumber?, (any Error)?) -> Void)

func readAttributeAdminFabricIndex(completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

func readAttributeAdminVendorId(completion: (NSNumber?, (any Error)?) -> Void)

func readAttributeAdminVendorId(completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated
...
func readAttributeWindowStatus(completion: (NSNumber?, (any Error)?) -> Void)

func readAttributeWindowStatus(completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

func revokeCommissioning(completion: MTRStatusCompletion)

func revokeCommissioning(completionHandler: MTRStatusCompletion)Deprecated

func revokeCommissioning(with: MTRAdministratorCommissioningClusterRevokeCommissioningParams?, completion: MTRStatusCompletion)

func revokeCommissioning(with: MTRAdministratorCommissioningClusterRevokeCommissioningParams?, completionHandler: MTRStatusCompletion)Deprecated
...
func subscribeAttributeAdminFabricIndex(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)

func subscribeAttributeAdminFabricIndex(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

func subscribeAttributeAdminVendorId(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)

func subscribeAttributeAdminVendorId(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)Deprecated
...
func subscribeAttributeWindowStatus(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)

func subscribeAttributeWindowStatus(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)Deprecated
...
class func readAttributeAdminFabricIndex(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

class func readAttributeAdminFabricIndex(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)

class func readAttributeAdminVendorId(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

class func readAttributeAdminVendorId(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)
...
class func readAttributeWindowStatus(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

class func readAttributeWindowStatus(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)
