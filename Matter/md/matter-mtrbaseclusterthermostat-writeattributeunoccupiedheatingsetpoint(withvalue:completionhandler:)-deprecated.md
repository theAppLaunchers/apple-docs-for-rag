...
-  writeAttributeUnoccupiedHeatingSetpoint(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeUnoccupiedHeatingSetpoint(
...
Please use writeAttributeUnoccupiedHeatingSetpointWithValue:completion:
