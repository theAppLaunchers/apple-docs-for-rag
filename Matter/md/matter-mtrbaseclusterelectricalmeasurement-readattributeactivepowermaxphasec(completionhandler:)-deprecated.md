...
-  readAttributeActivePowerMaxPhaseC(completionHandler:) Deprecated
...
``` source
func readAttributeActivePowerMaxPhaseC(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
