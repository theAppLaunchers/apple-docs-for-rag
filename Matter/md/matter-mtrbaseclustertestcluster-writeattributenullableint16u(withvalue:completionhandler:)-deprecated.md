...
-  writeAttributeNullableInt16u(withValue:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableInt16u(
...
Please use writeAttributeNullableInt16uWithValue:completion:
