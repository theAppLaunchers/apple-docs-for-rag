...
-  readAttributeAcActivePowerOverload(completionHandler:) Deprecated
...
``` source
func readAttributeAcActivePowerOverload(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
