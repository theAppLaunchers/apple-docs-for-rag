...
- Matter
- MTRBaseClusterBasic
-  writeAttributeLocation(withValue:params:completionHandler:) Deprecated
...
Please use writeAttributeLocationWithValue:params:completion:
