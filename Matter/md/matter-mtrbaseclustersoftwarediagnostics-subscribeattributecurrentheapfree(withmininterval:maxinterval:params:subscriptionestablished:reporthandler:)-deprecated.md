...
-  subscribeAttributeCurrentHeapFree(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeCurrentHeapFree(
