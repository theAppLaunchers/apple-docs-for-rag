...
func launchContent(with: MTRContentLauncherClusterLaunchContentParams, completion: (MTRContentLauncherClusterLauncherResponseParams?, (any Error)?) -> Void)

func launchContent(with: MTRContentLauncherClusterLaunchContentParams, completionHandler: (MTRContentLauncherClusterLaunchResponseParams?, (any Error)?) -> Void)Deprecated

func launchURL(with: MTRContentLauncherClusterLaunchURLParams, completion: (MTRContentLauncherClusterLauncherResponseParams?, (any Error)?) -> Void)

func launchURL(with: MTRContentLauncherClusterLaunchURLParams, completionHandler: (MTRContentLauncherClusterLaunchResponseParams?, (any Error)?) -> Void)Deprecated

func readAttributeAcceptHeader(completion: ([Any]?, (any Error)?) -> Void)

func readAttributeAcceptHeader(completionHandler: ([Any]?, (any Error)?) -> Void)Deprecated
...
func readAttributeSupportedStreamingProtocols(completion: (NSNumber?, (any Error)?) -> Void)

func readAttributeSupportedStreamingProtocols(completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

func subscribeAttributeAcceptHeader(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)

func subscribeAttributeAcceptHeader(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: ([Any]?, (any Error)?) -> Void)Deprecated
...
func subscribeAttributeSupportedStreamingProtocols(with: MTRSubscribeParams, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)

func subscribeAttributeSupportedStreamingProtocols(withMinInterval: NSNumber, maxInterval: NSNumber, params: MTRSubscribeParams?, subscriptionEstablished: MTRSubscriptionEstablishedHandler?, reportHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, completion: MTRStatusCompletion)

func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, completionHandler: MTRStatusCompletion)Deprecated

func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, params: MTRWriteParams?, completion: MTRStatusCompletion)

func writeAttributeSupportedStreamingProtocols(withValue: NSNumber, params: MTRWriteParams?, completionHandler: MTRStatusCompletion)Deprecated

### Type Methods

class func readAttributeAcceptHeader(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: ([Any]?, (any Error)?) -> Void)Deprecated

class func readAttributeAcceptHeader(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: ([Any]?, (any Error)?) -> Void)
...
class func readAttributeSupportedStreamingProtocols(withAttributeCache: MTRAttributeCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completionHandler: (NSNumber?, (any Error)?) -> Void)Deprecated

class func readAttributeSupportedStreamingProtocols(withClusterStateCache: MTRClusterStateCacheContainer, endpoint: NSNumber, queue: dispatch_queue_t, completion: (NSNumber?, (any Error)?) -> Void)
