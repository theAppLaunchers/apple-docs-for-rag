...
-  timedInvokeRequest(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func timedInvokeRequest(
    with params: MTRTestClusterClusterTimedInvokeRequestParams?,
