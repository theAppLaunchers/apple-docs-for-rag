...
-  writeAttributeACCompressorType(withValue:params:completionHandler:) Deprecated
...
``` source
func writeAttributeACCompressorType(
...
Please use writeAttributeACCompressorTypeWithValue:params:completion:
