...
-  logout(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
Please use logoutWithParams:expectedValues:expectedValueInterval:completion:
