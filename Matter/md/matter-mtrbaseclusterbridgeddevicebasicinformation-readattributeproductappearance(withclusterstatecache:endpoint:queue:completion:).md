...
class func readAttributeProductAppearance(
    ...
    completion: @escaping (MTRBridgedDeviceBasicInformationClusterProductAppearanceStruct?, (any Error)?) -> Void
)
```
...
class func readAttributeProductAppearance(
    ...
    endpoint: NSNumber,
    queue: dispatch_queue_t
) async throws -> MTRBridgedDeviceBasicInformationClusterProductAppearanceStruct
```
