...
-  readAttributeBallastFactorAdjustment(completionHandler:) Deprecated
...
``` source
func readAttributeBallastFactorAdjustment(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
