...
-  writeAttributeNullableBitmap64(withValue:params:completionHandler:) Deprecated
...
``` source
func writeAttributeNullableBitmap64(
...
Please use writeAttributeNullableBitmap64WithValue:params:completion:
