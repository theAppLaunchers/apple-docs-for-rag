...
-  commissioningComplete(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated

Instance Method

# commissioningComplete(with:expectedValues:expectedValueInterval:completionHandler:)
...
func commissioningComplete(
    ...
    expectedValues expectedDataValueDictionaries: [[String : Any]]?,
    expectedValueInterval expectedValueIntervalMs: NSNumber?
) async throws -> MTRGeneralCommissioningClusterCommissioningCompleteResponseParams
```
