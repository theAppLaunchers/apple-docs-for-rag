...
-  writeAttributeStructAttr(withValue:params:completionHandler:) Deprecated
...
``` source
func writeAttributeStructAttr(
    withValue value: MTRTestClusterClusterSimpleStruct,
...
Please use writeAttributeStructAttrWithValue:params:completion:
