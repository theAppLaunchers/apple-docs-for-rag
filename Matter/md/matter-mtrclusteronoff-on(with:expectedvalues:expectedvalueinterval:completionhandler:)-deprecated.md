...
- Matter
- MTRClusterOnOff
-  on(with:expectedValues:expectedValueInterval:completionHandler:) Deprecated
...
``` source
func on(
    with params: MTROnOffClusterOnParams?,
...
Please use onWithParams:expectedValues:expectedValueInterval:completion:
