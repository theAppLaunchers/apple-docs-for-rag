...
-  subscribeAttributeNullableInt56u(withMinInterval:maxInterval:params:subscriptionEstablished:reportHandler:) Deprecated
...
``` source
func subscribeAttributeNullableInt56u(
