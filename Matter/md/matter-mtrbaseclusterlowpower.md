...
func sleep(completion: MTRStatusCompletion)

func sleep(completionHandler: MTRStatusCompletion)Deprecated

func sleep(with: MTRLowPowerClusterSleepParams?, completion: MTRStatusCompletion)

func sleep(with: MTRLowPowerClusterSleepParams?, completionHandler: MTRStatusCompletion)Deprecated
