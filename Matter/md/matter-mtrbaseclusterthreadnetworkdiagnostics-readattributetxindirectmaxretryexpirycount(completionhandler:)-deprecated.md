...
-  readAttributeTxIndirectMaxRetryExpiryCount(completionHandler:) Deprecated
...
``` source
func readAttributeTxIndirectMaxRetryExpiryCount(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
