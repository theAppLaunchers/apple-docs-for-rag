...
-  readAttributeAverageRmsUnderVoltage(completionHandler:) Deprecated
...
``` source
func readAttributeAverageRmsUnderVoltage(completionHandler: @escaping (NSNumber?, (any Error)?) -> Void)
```
