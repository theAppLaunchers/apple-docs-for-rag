...
func getSetupPIN(with: MTRAccountLoginClusterGetSetupPINParams, completion: (MTRAccountLoginClusterGetSetupPINResponseParams?, (any Error)?) -> Void)

func getSetupPIN(with: MTRAccountLoginClusterGetSetupPINParams, completionHandler: (MTRAccountLoginClusterGetSetupPINResponseParams?, (any Error)?) -> Void)Deprecated

func login(with: MTRAccountLoginClusterLoginParams, completion: MTRStatusCompletion)

func login(with: MTRAccountLoginClusterLoginParams, completionHandler: MTRStatusCompletion)Deprecated

func logout(completion: MTRStatusCompletion)

func logout(completionHandler: MTRStatusCompletion)Deprecated

func logout(with: MTRAccountLoginClusterLogoutParams?, completion: MTRStatusCompletion)

func logout(with: MTRAccountLoginClusterLogoutParams?, completionHandler: MTRStatusCompletion)Deprecated
