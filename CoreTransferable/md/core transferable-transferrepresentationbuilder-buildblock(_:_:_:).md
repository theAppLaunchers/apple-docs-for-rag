...
static func buildBlock(
    ...
    _ content2: C2,
    _ content3: C3
) -> TupleTransferRepresentation where Item == C1.Item, C1 : TransferRepresentation, C2 : TransferRepresentation, C3 : TransferRepresentation, C1.Item == C2.Item, C2.Item == C3.Item
```
