...
``` source
struct MonthlyWeatherStatistics where T : Decodable, T : Encodable, T : Equatable, T : Sendable
```
...
static func == (MonthlyWeatherStatistics&lt;T>, MonthlyWeatherStatistics&lt;T>) -> Bool
...
var endIndex: MonthlyWeatherStatistics&lt;T>.Index
...
var startIndex: MonthlyWeatherStatistics&lt;T>.Index
...
subscript(MonthlyWeatherStatistics&lt;T>.Index) -> MonthlyWeatherStatistics&lt;T>.Element
