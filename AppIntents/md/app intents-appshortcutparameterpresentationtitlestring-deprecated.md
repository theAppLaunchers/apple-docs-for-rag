...
- App Intents
-  AppShortcutParameterPresentationTitleString Deprecated
...
``` source
struct AppShortcutParameterPresentationTitleString where Intent : AppIntent, Value : _IntentValue, Value : Sendable, Parameter : IntentParameter, ParameterKeyPath : KeyPath
```
