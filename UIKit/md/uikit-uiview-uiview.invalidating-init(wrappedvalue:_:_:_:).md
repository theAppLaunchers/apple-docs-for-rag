...
) where InvalidationType == UIView.Invalidations.Tuple, InvalidationType3>, InvalidationType1 : UIViewInvalidating, InvalidationType2 : UIViewInvalidating, InvalidationType3 : UIViewInvalidating
```
