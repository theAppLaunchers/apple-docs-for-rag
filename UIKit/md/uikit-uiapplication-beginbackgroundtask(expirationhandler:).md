...
If you’re having trouble debugging your background task code, you might try using the beginBackgroundTask(withName:expirationHandler:) method instead of this one. That method provides the same behavior but lets you specify a debugger-visible name for your task.
