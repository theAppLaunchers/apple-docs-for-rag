...
iOS 4.3+iPadOS 4.3+Mac Catalyst 13.1+macOS 10.5+tvOS 9.0+visionOS 1.0+watchOS 2.0+
...
Value must be a doc://com.apple.documentation/documentation/corefoundation/cfboolean-s0p object. Default is kCFBooleanFalse. A value of kCFBooleanFalse indicates that horizontal glyph forms are to be used; kCFBooleanTrue indicates that vertical glyph forms are to be used.
