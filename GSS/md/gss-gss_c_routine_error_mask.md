...
Shift the mask to the left by GSS_C_ROUTINE_ERROR_OFFSET to put it in the correct position within the major status code to match the routine error field. The GSS_ROUTINE_ERROR macro does this for you, before bitwise `AND`ing with its input.
