...
Shift the mask to the left by GSS_C_SUPPLEMENTARY_OFFSET to put it in the correct position within the major status code to match the supplementary information field. The GSS_SUPPLEMENTARY_INFO macro does this for you, before bitwise `AND`ing with its input.
