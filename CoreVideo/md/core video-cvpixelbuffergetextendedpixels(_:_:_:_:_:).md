...
func CVPixelBufferGetExtendedPixels(
    ...
    _ extraColumnsOnLeft: UnsafeMutablePointer?,
    _ extraColumnsOnRight: UnsafeMutablePointer?,
    _ extraRowsOnTop: UnsafeMutablePointer?,
    _ extraRowsOnBottom: UnsafeMutablePointer?
)
```
