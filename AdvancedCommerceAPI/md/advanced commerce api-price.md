...
Provide SKU prices using the supported number of decimal places for the currency, in milliunit format. For more information, see Specifying prices for Advanced Commerce SKUs.
