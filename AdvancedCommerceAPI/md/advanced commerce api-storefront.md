...
To get storefront information in your app, use Storefront. Get the countryCode value of the current storefront, and use that value for `storefront`. Use updates to listen for changes to the storefront.
