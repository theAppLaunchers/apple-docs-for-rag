...
The `bool` value to insert. After calling this method, the XPC object corresponding to the primitive value inserted may be safely retrieved with xpc_array_get_value(_:_:).
