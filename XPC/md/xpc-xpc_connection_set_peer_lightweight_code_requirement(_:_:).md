...
``` source
func xpc_connection_set_peer_lightweight_code_requirement(
...
The lightweight code requirement to test for the peer process’s executable. Create an object of type XPC_TYPE_DICTIONARY that represents the requirement, using keys and values from Defining launch environment and library constraints.
