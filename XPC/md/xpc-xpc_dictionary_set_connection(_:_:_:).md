...
``` source
func xpc_dictionary_set_connection(
...
The connection to insert. After calling this method, the XPC object corresponding to the primitive value inserted may be safely retrieved with xpc_dictionary_get_value(_:_:). The connection is NOT retained by the dictionary.
