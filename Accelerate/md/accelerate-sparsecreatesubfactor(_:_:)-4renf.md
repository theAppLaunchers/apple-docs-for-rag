...
func SparseCreateSubfactor(
    ...
    _ Factor: SparseOpaqueFactorization_Float
...
A `SparseOpaqueSubfactor_Float` structure that represents the subfactor. You must free the resource through a call to SparseCleanup(_:) after you finish with the object.
