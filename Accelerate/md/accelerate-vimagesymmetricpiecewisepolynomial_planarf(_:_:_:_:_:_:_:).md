...
The vImageSymmetricPiecewisePolynomial_PlanarF(_:_:_:_:_:_:_:) function differs from the vImagePiecewisePolynomial_PlanarF(_:_:_:_:_:_:_:) function in that it uses the following modified polynomial that’s symmetric about zero:
