...
func dlasdt_(
    _ n: UnsafePointer,
    _ lvl: UnsafeMutablePointer,
    _ nd: UnsafeMutablePointer,
    _ inode: UnsafeMutablePointer?,
    _ ndiml: UnsafeMutablePointer?,
    _ ndimr: UnsafeMutablePointer?,
    _ msub: UnsafePointer
)
```
