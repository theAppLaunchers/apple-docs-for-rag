...
- Accelerate
- BNNS
-  tileBackward(outputGradient:generatingInputGradient:filterParameters:) Deprecated
...
The output gradient descriptor.

`inputGradient`  

The input gradient descriptor.
