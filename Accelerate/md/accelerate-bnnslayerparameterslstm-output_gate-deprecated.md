...
Use C style multidimensional array notation to order the memory pointers as `[` num_layers `][num_directions][` hidden_size `][` input_size / hidden_size `]`.
