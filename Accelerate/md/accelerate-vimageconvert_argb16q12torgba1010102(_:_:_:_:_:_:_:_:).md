...
func vImageConvert_ARGB16Q12ToRGBA1010102(
    ...
    _ RGB101010Min: Int32,
    _ RGB101010Max: Int32,
...
The minimum pixel value for the destination image range.

`RGB101010RangeMax`  

The maximum pixel value for the destination image range.
