...
The scratch space of size solveWorkspaceRequiredStatic `+` `nrhs` `*` solveWorkspaceRequiredPerRHS, where *n_rhs* is the number of right-hand-sides to find solutions for.
