...
- Accelerate
-  la_add_attributes(\_:\_:) Deprecated
...
``` source
func la_add_attributes(
    _ object: la_object_t,
...
Attributes which are to be added to the object’s existing attributes to create its new set of attributes. This value should be constructed by or’ing together LA_ATTRIBUTE\_\* constants.
