...
An array of three 8-bit integers with the values `0`, `1`, and `2`, in some order. Each value specifies the channel from the source image that the function copies to the destination channel at the corresponding index.
