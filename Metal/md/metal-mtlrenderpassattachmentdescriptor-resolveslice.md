...
If the value of storeAction is set to MTLStoreAction.multisampleResolve or MTLStoreAction.storeAndMultisampleResolve, set this property to point to a slice in the resolve texture.
