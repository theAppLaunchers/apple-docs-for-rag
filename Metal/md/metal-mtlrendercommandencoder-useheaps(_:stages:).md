...
iOS 13.0+iPadOS 13.0+Mac Catalyst 13.1+macOS 10.15+tvOS 13.0+visionOS
...
An array of MTLHeap instances with resources that subsequent draw commands depend on.
