...
let sourceBuffer = , privateBuffer = , bufferLength = 
...
sourceBuffer = , textureSize = , privateTexture = , textureOrigin = 
...
let bytesPerRow = pixelSize * textureSize.width
let bytesPerImage = pixelSize * textureSize.width * textureSize.height
let privateBuffer = , bufferLength = 
