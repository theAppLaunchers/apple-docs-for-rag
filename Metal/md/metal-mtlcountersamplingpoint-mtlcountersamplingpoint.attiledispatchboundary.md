...
When a Metal device object supports this sampling boundary, you can call the sampleCounters(sampleBuffer:sampleIndex:barrier:) method on a MTLRenderCommandEncoder to sample the counters between individual tile shader dispatches commands.
