...
The property defaults to `nil`, which means the GPU doesn’t save any GPU counter information during the compute pass. See Creating a Counter Sample Buffer to Store a GPU’s Counter Data During a Pass and Sampling GPU Data into Counter Sample Buffers for more information.
