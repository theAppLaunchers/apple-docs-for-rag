...
func controlWidgetActionHint(LocalizedStringKey) -> some View

The action hint of the control described by the modified label.

func controlWidgetActionHint&lt;S>(S) -> some View

The action hint of the control described by the modified label.

func controlWidgetActionHint(Text) -> some View

The action hint of the control described by the modified label.

func controlWidgetStatus(Text) -> some View

The status of the control described by the modified label.

func controlWidgetStatus(LocalizedStringKey) -> some View

The status of the control described by the modified label.

func controlWidgetStatus&lt;S>(S) -> some View
