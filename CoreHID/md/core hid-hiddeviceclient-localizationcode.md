...
The localization code can specify for which specific format the device is localized. For example, a Japanese (JIS) keyboard should declare the HIDDeviceLocalizationCode.japan localization code.
