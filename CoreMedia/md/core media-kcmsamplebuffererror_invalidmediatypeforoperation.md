...
This error occurs, for example, if you call the withUnsafeAudioStreamPacketDescriptions(_:) with nonaudio data.
...
var kCMSampleBufferError_BufferHasNoSampleTimingInfo: OSStatus
