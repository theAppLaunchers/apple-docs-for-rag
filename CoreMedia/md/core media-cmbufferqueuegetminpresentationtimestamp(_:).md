...
The search for earliest presentation timstamp is performed in this API. If you know your queue is sorted by presentation time, CMBufferQueueGetBufferCount(_:) is a faster alternative. If the `getPresentationTimeStamp` callback is `NULL`, kCMTimeInvalid will be returned.
