...
- Core Media
-  CMTimebaseCreateWithMasterClock(allocator:masterClock:timebaseOut:) Deprecated
...
``` source
func CMTimebaseCreateWithMasterClock(
...
Use CMTimebaseCreateWithSourceClock(allocator:sourceClock:timebaseOut:) instead.
