...
- Core Media
-  CMTimebaseCreateWithMasterTimebase(allocator:masterTimebase:timebaseOut:) Deprecated
...
iOS 6.0–8.0DeprecatediPadOS 6.0–8.0DeprecatedMac Catalyst 13.1–13.1DeprecatedmacOS 10.8–10.10DeprecatedtvOS 9.0–9.0DeprecatedvisionOS 1.0–1.0DeprecatedwatchOS 6.0–6.0Deprecated

``` source
func CMTimebaseCreateWithMasterTimebase(
...
Use CMTimebaseCreateWithSourceTimebase(allocator:sourceTimebase:timebaseOut:) instead.
