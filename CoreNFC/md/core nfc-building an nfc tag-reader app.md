...
- The phone successfully read an NFC tag with a reader session configured to invalidate the session after reading the first tag. The error code is NFCReaderError.Code.readerSessionInvalidationErrorFirstNDEFTagRead.
