...
When you receive an error of this type, the underlyingErrorsKey key in the userInfo dictionary provides an array of the individual errors contributing to this one.
