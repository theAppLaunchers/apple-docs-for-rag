...
static func types(tag: String, tagClass: UTTagClass, conformingTo: UTType?) -> [UTType]
...
static var heics: UTType

A High Efficiency Image Coding Image Sequence.

static var jpegxl: UTType

A JPEG-XL encoded image.

static var linkPresentationMetadata: UTType

Serialized LinkPresentation metadata.

static var tarArchive: UTType

A tar Archive.

### Default Implementations

ReferenceConvertible Implementations
