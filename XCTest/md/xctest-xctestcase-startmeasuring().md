...
You must call measureMetrics(_:automaticallyStartMeasuring:for:) with an `automaticallyStartMeasuring` value of false in order to set a custom start point with startMeasuring().
