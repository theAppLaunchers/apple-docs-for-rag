...
optional func webExtensionController(
    ...
    promptForPermissionToAccess urls: Set,
...
The set of URLs that the extension is requesting access to.
...
A block to be called with the set of allowed URLs and an optional expiration date.
