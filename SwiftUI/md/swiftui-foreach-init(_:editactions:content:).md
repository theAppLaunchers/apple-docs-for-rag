...
) where Data == IndexedIdentifierCollection, ID == C.Element.ID, Content == EditableCollectionContent, C : MutableCollection, C : RandomAccessCollection, R : View, C.Element : Identifiable, C.Index : Hashable
```
