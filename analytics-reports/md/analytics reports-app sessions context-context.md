...
The data in this report details how frequently people use your application. This report is similar to App Sessions, but includes data for iOS across all distribution methods. Use App Sessions to understand usage of your App Store distributed App, and use App Sessions Context to provide more context to most of the Framework Usage and Performance reports.
