...
The transfer mode specifies which Boolean operation QuickDraw performs when drawing or transferring an image from one location to another. See Graphics modes for more information about graphics modes supported by QuickTime.
