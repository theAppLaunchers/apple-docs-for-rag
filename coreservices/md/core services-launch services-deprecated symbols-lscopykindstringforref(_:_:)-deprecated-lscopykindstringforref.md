...
- Launch Services
- Deprecated Symbols
-  LSCopyKindStringForRef(\_:\_:) Deprecated
...
Use LSCopyKindStringForURL(_:_:) or the URL resource property kCFURLLocalizedTypeDescriptionKey/localizedTypeDescriptionKey instead.
