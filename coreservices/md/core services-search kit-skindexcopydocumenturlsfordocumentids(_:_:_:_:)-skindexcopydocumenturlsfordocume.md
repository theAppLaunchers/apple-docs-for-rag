...
func SKIndexCopyDocumentURLsForDocumentIDs(
    ...
    _ outDocumentURLsArray: UnsafeMutablePointer?>!
)
```
...
The `SKIndexCopyDocumentURLsForDocumentIDs(_:_:_:_:)` function lets you get a batch of document URLs (CFURL objects) in one step, based on a list of document IDs.

If you want to get Search Kit Document URL objects (SKDocumentRefs) instead, use SKIndexCopyDocumentRefsForDocumentIDs(_:_:_:_:).
