...
- Core Services
- Carbon Core
-  Text Encoding Conversion Manager Deprecated
...
The most common result codes returned by Text Encoding ConversionManager are listed below.
