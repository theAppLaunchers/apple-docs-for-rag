...
- Launch Services
- Deprecated Symbols
-  LSCopyItemInfoForRef(\_:\_:\_:) Deprecated
...
``` source
func LSCopyItemInfoForRef(
    _ inItemRef: UnsafePointer!,
    _ inWhichInfo: LSRequestedInfo,
    _ outItemInfo: UnsafeMutablePointer!
) -> OSStatus
```

Deprecated

Use LSCopyItemInfoForURL(_:_:_:) or URL resource properties instead.
