...
- Launch Services
- Deprecated Symbols
-  LSCanRefAcceptItem(\_:\_:\_:\_:\_:) Deprecated
...
``` source
func LSCanRefAcceptItem(
    _ inItemFSRef: UnsafePointer!,
    _ inTargetRef: UnsafePointer!,
...
Use LSCanURLAcceptURL(_:_:_:_:_:) instead.
