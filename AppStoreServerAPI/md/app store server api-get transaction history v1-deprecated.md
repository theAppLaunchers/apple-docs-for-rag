...
App Store Server API 1.0–1.12Deprecated

Deprecated

Use Get Transaction History instead, which gets the history for all product types, including consumable in-app purchases in the finished state.
...
Use Get Transaction History instead to get all the product types, including consumable in-app purchases in the finished state.
