...
-  InvalidTransactionNotConsumableError Deprecated
...
App Store Server API 1.9–1.11Deprecated
...
The system no longer sends this error. See InvalidTransactionTypeNotSupportedError instead.
