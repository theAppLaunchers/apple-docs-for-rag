...
-  addMenuItem(with:title:action:) Deprecated
...
The template image to be used for the action. Only the alpha channel of the image is used. This parameter must not be `nil`. For information about the dimensions for menu images, see Apple Watch Human Interface Guidelines.
