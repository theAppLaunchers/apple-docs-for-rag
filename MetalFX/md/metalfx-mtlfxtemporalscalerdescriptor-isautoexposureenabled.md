...
Set this property to true to create a temporal scaler that automatically calculates the exposure level for each image it scales.

Note

Temporal scaler instances that use auto exposure ignore its exposureTexture property.
