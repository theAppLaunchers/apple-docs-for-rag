...
A postback in SKAdNetwork version 4 and later provides this fineConversionValue or a coarseConversionValue. Earlier versions of SKAdNetwork use a single conversionValue.
