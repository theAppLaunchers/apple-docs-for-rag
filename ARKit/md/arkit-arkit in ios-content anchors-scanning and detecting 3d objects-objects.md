...
- Use the ARObjectScanningConfigurationand ARReferenceObject classes as demonstrated in this sample app to record reference objects as part of your own asset production pipeline.
...
sceneView.session.createReferenceObject(
    ...
    center: SIMD3(), extent: boundingBox.extent,
