...
- Package
- Package.Dependency
-  Package.Dependency.Requirement Deprecated
...
static func branch(String) -> Package.Dependency.Requirement

Returns a requirement for a source control branch.

static func exact(Version) -> Package.Dependency.Requirement

Returns a requirement for the given exact version.

static func revision(String) -> Package.Dependency.Requirement

Returns a requirement for a source control revision such as the hash of a commit.

static func upToNextMajor(from: Version) -> Package.Dependency.Requirement

A source control requirement bounded to the given version’s major version number.

static func upToNextMinor(from: Version) -> Package.Dependency.Requirement
