...
The caller should not release this mach_port_t. Just call IONotificationPortDestroy(_:) to dispose of the mach_port_t and IONotificationPortRef when done.
