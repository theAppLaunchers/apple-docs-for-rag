...
iOS 18.4+iPadOS 18.4+Mac Catalyst 13.0+macOS 10.2+visionOS 2.4+
...
The primary port obtained from IOMasterPort(_:_:). Pass kIOMasterPortDefault to look up the default primary port.
...
func IOServiceMatchPropertyTable(io_service_t, CFDictionary!, UnsafeMutablePointer&lt;boolean_t>!) -> kern_return_t
