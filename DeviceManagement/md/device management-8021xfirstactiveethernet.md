...
Interface (String)  
This payload uses the value `FirstActiveEthernet`.
...
```
    ...
    PayloadContent
            ...
            PayloadIdentifier
            com.example.my8021xfaepayload
            PayloadType
            com.apple.firstactiveethernet.managed
            PayloadUUID
            9a7d074f-5822-4507-8e8c-80e479d95001
            PayloadVersion
            1

    PayloadDisplayName
    802.1x First Active Ethernet
    PayloadIdentifier
    com.example.myprofile
    PayloadType
    Configuration
    PayloadUUID
    fea1c6f3-5d95-4db9-be46-c130fb475409
    PayloadVersion
    1
