...
Use the value in this property when displaying the color name in your user interface. Access this property only for colors in the named color space. Accessing it for other color types raises an exception.
