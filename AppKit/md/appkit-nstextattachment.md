...
The NSAttributedString class uses text attachment objects as the values for attachment attributes (stored in the attributed string under the attachment key).
...
var attachmentCell: (any NSTextAttachmentCellProtocol)?
