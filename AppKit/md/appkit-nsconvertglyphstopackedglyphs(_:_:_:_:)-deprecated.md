...
- AppKit
-  NSConvertGlyphsToPackedGlyphs(\_:\_:\_:\_:) Deprecated
...
``` source
func NSConvertGlyphsToPackedGlyphs(
    _ glBuf: UnsafeMutablePointer,
    _ count: Int,
    _ packing: NSMultibyteGlyphPacking,
    _ packedGlyphs: UnsafeMutablePointer
) -> Int
```
