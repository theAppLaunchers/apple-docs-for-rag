...
An object encapsulating information about the tablet-point event. Tablet-point events describe the current state of a pointing device that is in proximity to its tablet, reflecting changes such as location, pressure, tilt, and rotation. For more information, see NSEvent.
