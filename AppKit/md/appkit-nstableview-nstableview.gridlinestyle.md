...
static var solidVerticalGridLineMask: NSTableView.GridLineStyle

Specifies that vertical grid lines should be displayed.

static var solidHorizontalGridLineMask: NSTableView.GridLineStyle

Specifies that horizontal grid lines should be displayed.

static var dashedHorizontalGridLineMask: NSTableView.GridLineStyle
