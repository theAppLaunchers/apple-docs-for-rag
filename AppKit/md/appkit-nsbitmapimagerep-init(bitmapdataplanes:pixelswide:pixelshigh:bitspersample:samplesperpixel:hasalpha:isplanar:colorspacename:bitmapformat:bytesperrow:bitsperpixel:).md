...
An integer that specifies the ordering of the bitmap components. It is a mask created by combining the NSBitmapImageRep.Format constants alphaFirst, alphaNonpremultiplied and floatingPointSamples using the C bitwise OR operator.
