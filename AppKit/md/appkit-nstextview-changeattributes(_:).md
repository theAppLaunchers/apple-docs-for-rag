...
This method changes the attributes by invoking convertAttributes(_:) on `sender` and applying the returned attributes to the appropriate text. See Font Handling in Cocoa Text Architecture Guide for more information on attribute conversion.
