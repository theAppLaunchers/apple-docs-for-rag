...
A dictionary object that contains information about the speech synthesizer being used on the specified synthesizer. See NSSpeechSynthesizer.SpeechPropertyKey.SynthesizerInfoKey for a description of the keys present in the dictionary.
