...
func next() async rethrows -> SegmentOfResult.Element?

Produces the next element in the flat map sequence.

func next(isolation: isolated (any Actor)?) async throws(AsyncFlatMapSequence&lt;Base, SegmentOfResult>.Failure) -> SegmentOfResult.Element?
