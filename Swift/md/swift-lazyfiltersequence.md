...
``` source
@frozen
struct LazyFilterSequence where Base : Sequence
```
...
func filter((LazyFilterSequence&lt;Base>.Element) -> Bool) -> LazyFilterSequence&lt;Base>

func formIndex(inout LazyFilterSequence&lt;Base>.Index, offsetBy: Int)

func formIndex(inout LazyFilterSequence&lt;Base>.Index, offsetBy: Int, limitedBy: LazyFilterSequence&lt;Base>.Index) -> Bool
