...
func next() async rethrows -> ElementOfResult?

Produces the next element in the compact map sequence.

func next(isolation: isolated (any Actor)?) async throws(AsyncCompactMapSequence&lt;Base, ElementOfResult>.Failure) -> ElementOfResult?
