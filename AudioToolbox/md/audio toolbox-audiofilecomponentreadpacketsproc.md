...
``` source
typealias AudioFileComponentReadPacketsProc = (UnsafeMutableRawPointer, DarwinBoolean, UnsafeMutablePointer, UnsafeMutablePointer?, Int64, UnsafeMutablePointer, UnsafeMutableRawPointer) -> OSStatus
```
