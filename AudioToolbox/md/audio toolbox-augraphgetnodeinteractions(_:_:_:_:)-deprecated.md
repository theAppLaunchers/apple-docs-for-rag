...
- Audio Toolbox
-  AUGraphGetNodeInteractions(\_:\_:\_:\_:) Deprecated
...
iOS 2.0–14.0DeprecatediPadOS 2.0–14.0DeprecatedMac Catalyst 13.1+macOS 10.5–11.0DeprecatedtvOS 9.0+visionOS 1.0+

``` source
func AUGraphGetNodeInteractions(
    _ inGraph: AUGraph,
    _ inNode: AUNode,
    _ ioNumInteractions: UnsafeMutablePointer,
    _ outInteractions: UnsafeMutablePointer
) -> OSStatus
```
