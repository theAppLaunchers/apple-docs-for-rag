...
- Audio Toolbox
-  AudioHardwareServiceAddPropertyListener(\_:\_:\_:\_:) Deprecated
...
The HAL audio object to register the listener callback function with.

`inAddress`  

The property that, when changed, triggers a call to your listener callback function.

`inListener`  

He property listener callback to register.

`inClientData`  

Application data that is passed to your listener callback when it is invoked.
