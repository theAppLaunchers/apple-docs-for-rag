...
- Audio Toolbox
-  AUGraphGetCPULoad(\_:\_:) Deprecated
...
iOS 2.0–14.0DeprecatediPadOS 2.0–14.0DeprecatedMac Catalyst 13.1+macOS 10.1–11.0DeprecatedtvOS 9.0+visionOS 1.0+

``` source
func AUGraphGetCPULoad(
    _ inGraph: AUGraph,
    _ outAverageCPULoad: UnsafeMutablePointer
) -> OSStatus
```
