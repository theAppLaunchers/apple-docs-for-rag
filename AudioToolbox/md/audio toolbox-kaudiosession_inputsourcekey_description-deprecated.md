...
- Audio Toolbox
-  kAudioSession_InputSourceKey_Description Deprecated
...
A CFString object, defined by the accessory, that describes an audio input source and that is suitable for displaying in a user interface.
