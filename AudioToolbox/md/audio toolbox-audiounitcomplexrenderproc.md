...
``` source
typealias AudioUnitComplexRenderProc = (UnsafeMutableRawPointer, UnsafeMutablePointer?, UnsafePointer, UInt32, UInt32, UnsafeMutablePointer, UnsafeMutablePointer, UnsafeMutablePointer, UnsafeMutableRawPointer, UnsafeMutablePointer) -> OSStatus
```
