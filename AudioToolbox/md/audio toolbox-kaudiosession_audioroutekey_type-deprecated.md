...
- Audio Toolbox
-  kAudioSession_AudioRouteKey_Type Deprecated
...
A CFString object that serves as the one key for an audio routes input or output dictionary, whose value specifies an input source or output destination.
