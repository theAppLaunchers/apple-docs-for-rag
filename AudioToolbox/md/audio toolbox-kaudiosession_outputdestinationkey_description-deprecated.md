...
- Audio Toolbox
-  kAudioSession_OutputDestinationKey_Description Deprecated
...
A CFString object, defined by the accessory, that describes the audio output destination and that is suitable for displaying in a user interface.
