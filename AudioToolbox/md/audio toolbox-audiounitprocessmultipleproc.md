...
``` source
typealias AudioUnitProcessMultipleProc = (UnsafeMutableRawPointer, UnsafeMutablePointer?, UnsafePointer, UInt32, UInt32, UnsafeMutablePointer>, UInt32, UnsafeMutablePointer>) -> OSStatus
```
