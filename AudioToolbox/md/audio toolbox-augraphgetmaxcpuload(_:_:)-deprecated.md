...
- Audio Toolbox
-  AUGraphGetMaxCPULoad(\_:\_:) Deprecated
...
iOS 2.0–14.0DeprecatediPadOS 2.0–14.0DeprecatedMac Catalyst 13.1+macOS 10.3–11.0DeprecatedtvOS 9.0+visionOS 1.0+

``` source
func AUGraphGetMaxCPULoad(
    _ inGraph: AUGraph,
    _ outMaxLoad: UnsafeMutablePointer
) -> OSStatus
```
