...
For information on which reasons your app or third-party SDK declares for each category of required reasons API it uses, see NSPrivacyAccessedAPIType.
...
**Name:** Privacy Accessed API Type
