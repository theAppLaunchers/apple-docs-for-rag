...
A tensor containing the scores of the input boxes. Must be a rank 3 tensor of shape \[N,B,1\] of type `MPSDataTypeFloat32`

`classIndicesTensor`  

A tensor containing the class indices of the input boxes. Must be a rank 2 tensor of shape \[N,B\] of type `MPSDataTypeInt32`
