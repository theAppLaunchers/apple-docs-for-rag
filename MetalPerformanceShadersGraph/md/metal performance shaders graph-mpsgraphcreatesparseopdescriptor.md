...
var sparseStorageType: MPSGraphSparseStorageType

Defines the storage format of the sparse tensor.

### Type Methods

class func sparseDescriptor(descriptorWithStorageType: MPSGraphSparseStorageType, dataType: MPSDataType) -> Self?
