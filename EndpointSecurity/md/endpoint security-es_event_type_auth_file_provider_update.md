...
This identifier corresponds to the es_events_t union member file_provider_update, which has the type es_event_file_provider_update_t.

See the File Provider framework for more information on file providers.
