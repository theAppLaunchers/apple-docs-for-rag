...
``` source
func es_release_muted_processes(_ muted_processes: UnsafeMutablePointer)
```
...
An es_muted_processes_t structure, previously populated by a call to es_muted_processes_events(_:_:), to release.
