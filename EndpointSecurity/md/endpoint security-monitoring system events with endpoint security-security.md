...
8.  In Terminal, run `sudo launchctl list .com.example.apple-samplecode.SampleEndpointApp.Extension` to verify that the system extension is running.
...
1.  In Terminal, run `systemextensionsctl uninstall  com.example.apple-samplecode.SampleEndpointApp.Extension`.
