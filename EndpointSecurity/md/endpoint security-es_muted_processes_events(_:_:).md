...
func es_muted_processes_events(
    ...
    _ muted_processes: UnsafeMutablePointer?>
) -> es_return_t
```
...
On output, a structure that contains the muted processes. You must dispose of this memory by calling es_release_muted_processes(_:).
