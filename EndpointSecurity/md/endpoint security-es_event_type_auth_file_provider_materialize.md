...
This identifier corresponds to the es_events_t union member file_provider_materialize, which has the type es_event_file_provider_materialize_t.

See the File Provider framework for more information on file provider materialization.
