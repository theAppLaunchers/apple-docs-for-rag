...
If your app uses APIs that have read or write access to the user’s Photos library, the NSPhotoLibraryUsageDescription key is required in your information property list.
