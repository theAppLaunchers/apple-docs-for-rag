...
An MLDataColumn of elements convertible to MLDataValue.SequenceType.
...
Then use init(column:) to convert the column to a column of sequences.

```
let sequenceColumn = MLDataColumn(column: stringsColumn)
