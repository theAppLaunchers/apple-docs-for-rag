...
A collection of labeled audio files represented by a dictionary. The keys of this dictionary are the labels, and the values are the associated audio-file URLs.
