...
-  makeTrainingSession(trainingData:featureColumns:labelColumn:recordingFileColumn:parameters:sessionParameters:) Deprecated
...
Use makeTrainingSession(trainingData:parameters:sessionParameters:
