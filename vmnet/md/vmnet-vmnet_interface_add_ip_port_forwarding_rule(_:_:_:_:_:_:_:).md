...
Mac Catalyst 13.0+macOS 11.0+

``` source
func vmnet_interface_add_ip_port_forwarding_rule(
    _ interface: interface_ref,
    _ protocol: UInt8,
    _ external_port: UInt16,
    _ address_family: UInt8,
    _ internal_address: UnsafeRawPointer,
    _ internal_port: UInt16,
    _ handler: vmnet_interface_completion_handler_t?
) -> vmnet_return_t
```
