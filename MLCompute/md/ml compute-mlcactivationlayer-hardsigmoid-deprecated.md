...
This factory creates an activation descriptor using init(type:a:b:), where `type =` MLCActivationType.hardSigmoid, `a = 0.2`, and `b = 0.5`, and passes that descriptor to init(descriptor:).
