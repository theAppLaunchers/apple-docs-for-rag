...
iOS 15.4+iPadOS 15.4+Mac Catalyst 15.4+macOS 12.3+tvOS 15.4+visionOS 1.0+watchOS 8.4+

``` source
func nw_framer_options_copy_object_value(
    _ options: nw_protocol_options_t,
    _ key: UnsafePointer
) -> Any?
```
