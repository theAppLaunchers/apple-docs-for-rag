...
The sample type for this sensor is SRFaceMetrics.

You need to provide a reason to record face metrics by adding the SRSensorUsageFacialMetrics dictionary to the NSSensorKitUsageDetail key in the information property list.
