...
To map the spatial location of the emitter, see the Apple Watch diagrams and emitter tables in Interpret second-generation PPG sensors data and Interpret third-generation PPG sensors.
