...
To map the spatial location of the active photodiodes, see the Apple Watch diagrams in Interpret second-generation PPG sensors data and Interpret third-generation PPG sensors.
