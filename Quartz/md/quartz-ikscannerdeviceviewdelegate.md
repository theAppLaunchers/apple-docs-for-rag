...
func scannerDeviceView(IKScannerDeviceView!, didScanTo: URL!, fileData: Data!, error: (any Error)!)

Invoked when the scan has completed and the data is available.

### Scanner Encountered Error

func scannerDeviceView(IKScannerDeviceView!, didEncounterError: (any Error)!)

Invoked whenever the scanner encounters an error.

### Instance Methods

func scannerDeviceView(IKScannerDeviceView!, didScanTo: URL!, error: (any Error)!)

func scannerDeviceView(IKScannerDeviceView!, didScanTo: ICScannerBandData!, scanInfo: [AnyHashable : Any]!, error: (any Error)!)
