...
This allows the application to programmatically dismiss the panel. The associated value is an `NSNumber` object that contains a `BOOL` value whose default value is false
