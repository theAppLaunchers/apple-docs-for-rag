...
``` source
@preconcurrency
func appending(_ other: Other) -> some SupervisedTemporalEstimator>, Other.Annotation> where Other : SupervisedEstimator, Other.Annotation : Sendable, Self.Transformer.Output == Other.Transformer.Input
```
