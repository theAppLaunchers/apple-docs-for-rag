...
) async throws -> PreprocessingSupervisedEstimator.Transformer where InputSequence : Sequence, Validation : Sequence, InputSequence.Element == AnnotatedFeature, Validation.Element == AnnotatedFeature
```
