...
func decode(from: inout any EstimatorDecoder) throws -> LinearTimeSeriesForecaster&lt;Scalar>.Transformer

Decodes a previously fitted model.

func encode(LinearTimeSeriesForecaster&lt;Scalar>.Transformer, to: inout any EstimatorEncoder) throws
