...
) async throws -> PreprocessingUpdatableSupervisedTemporalEstimator.Transformer where InputSequence : Sequence, FeatureSequence : TemporalSequence, Preprocessor.Input == FeatureSequence.Feature, InputSequence.Element == AnnotatedFeature
```
