...
``` source
struct TimeSeriesForecasterBatches where Scalar : MLShapedArrayScalar
```
...
init(features: MLShapedArray&lt;Scalar>, annotations: MLShapedArray&lt;Scalar>, batchSize: Int, inputWindowSize: Int, forecastWindowSize: Int, shufflesBatches: Bool) throws
...
func makeIterator() -> TimeSeriesForecasterBatches&lt;Scalar>.Iterator
