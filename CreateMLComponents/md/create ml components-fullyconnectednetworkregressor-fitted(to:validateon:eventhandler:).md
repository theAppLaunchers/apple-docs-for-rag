...
) async throws -> FullyConnectedNetworkRegressorModel where Input : Sequence, Validation : Sequence, Input.Element == AnnotatedFeature, Float>, Validation.Element == AnnotatedFeature, Float>
```
