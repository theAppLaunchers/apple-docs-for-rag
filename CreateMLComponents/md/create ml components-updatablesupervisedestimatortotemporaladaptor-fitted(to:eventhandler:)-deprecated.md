...
) async throws -> UpdatableSupervisedEstimatorToTemporalAdaptor.Transformer where InputSequence : Sequence, FeatureSequence : TemporalSequence, InputSequence.Element == AnnotatedFeature, FeatureSequence.Feature == Base.Transformer.Input
```
