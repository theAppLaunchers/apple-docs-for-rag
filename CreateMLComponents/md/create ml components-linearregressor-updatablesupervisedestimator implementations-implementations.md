...
func decodeWithOptimizer(from: inout any EstimatorDecoder) throws -> LinearRegressorModel&lt;Scalar>

Reads the encoded transformer and optimizer with a decoder.

func encodeWithOptimizer(LinearRegressorModel&lt;Scalar>, to: inout any EstimatorEncoder) throws
