...
``` source
struct PreprocessingUpdatableSupervisedEstimator where Preprocessor : Transformer, Estimator : UpdatableSupervisedEstimator, Preprocessor.Output == Estimator.Transformer.Input
```
