...
``` source
struct PreprocessingTabularEstimator where Preprocessor : TabularTransformer, Estimator : TabularEstimator
```
...
func decode(from: inout any EstimatorDecoder) throws -> PreprocessingTabularEstimator&lt;Preprocessor, Estimator>.Transformer
