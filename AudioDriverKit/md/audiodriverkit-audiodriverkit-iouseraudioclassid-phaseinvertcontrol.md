...
This class is a subclass of the IOUserAudioBooleanControl class where a `true` value indcates a phase inversion of the given element’s signal by 180 degrees.
