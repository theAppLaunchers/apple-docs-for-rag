...
This error can occur when the system is unable to prepare the card reader because the device is already being configured. Try to prepare the card reader again by calling the prepare(using:) method.
