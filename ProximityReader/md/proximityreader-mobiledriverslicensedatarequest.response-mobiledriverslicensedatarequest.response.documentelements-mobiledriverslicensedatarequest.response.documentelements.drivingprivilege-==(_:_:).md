...
``` source
static func == (a: MobileDriversLicenseDataRequest.Response.DocumentElements.DrivingPrivilege, b: MobileDriversLicenseDataRequest.Response.DocumentElements.DrivingPrivilege) -> Bool
```
