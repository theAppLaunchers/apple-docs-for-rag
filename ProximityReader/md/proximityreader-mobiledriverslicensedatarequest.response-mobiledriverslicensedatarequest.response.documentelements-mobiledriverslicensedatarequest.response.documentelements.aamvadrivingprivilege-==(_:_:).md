...
``` source
static func == (a: MobileDriversLicenseDataRequest.Response.DocumentElements.AAMVADrivingPrivilege, b: MobileDriversLicenseDataRequest.Response.DocumentElements.AAMVADrivingPrivilege) -> Bool
```
