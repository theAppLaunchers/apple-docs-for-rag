...
- The method updates the device’s configuration and delivers progress updates to the events attribute. Upon completion, the method returns a new PaymentCardReaderSession for the updated configuration. This process can take anywhere from a few seconds to several minutes.
