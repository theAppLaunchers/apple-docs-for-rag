...
``` source
static func == (a: MobileDriversLicenseDataRequest.Response.DocumentElements.DrivingPrivilege.Code, b: MobileDriversLicenseDataRequest.Response.DocumentElements.DrivingPrivilege.Code) -> Bool
```
