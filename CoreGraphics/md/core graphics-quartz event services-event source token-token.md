...
This constant is typically used with the function secondsSinceLastEventType(_:eventType:) to specify that you want the elapsed time since the last input event of any type.
