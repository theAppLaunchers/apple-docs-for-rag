...
``` source
func hv_gic_get_redistributor_base_alignment(_ redistributor_base_alignment: UnsafeMutablePointer) -> hv_return_t
```
...
A pointer to GIC redistributor base address alignment value that the framework writes to upon success.
