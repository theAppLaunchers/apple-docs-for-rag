...
``` source
func hv_gic_get_msi_reg(
    _ reg: hv_gic_msi_reg_t,
...
One of the GIC distributor MSI register enumeration values.

`value`  

A pointer to distributor MSI register value that the framework writes to upon success.
