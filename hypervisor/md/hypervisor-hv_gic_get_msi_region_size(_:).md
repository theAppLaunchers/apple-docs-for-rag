...
``` source
func hv_gic_get_msi_region_size(_ msi_region_size: UnsafeMutablePointer) -> hv_return_t
```
...
A pointer to GIC MSI region size that the framework writes to upon success.
