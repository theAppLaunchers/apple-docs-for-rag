...
``` source
func hv_gic_get_msi_region_base_alignment(_ msi_region_base_alignment: UnsafeMutablePointer) -> hv_return_t
```

## Parameters 

`msi_region_base_alignment`  

A pointer to GIC MSI region base address alignment that the framework writes to upon success.
