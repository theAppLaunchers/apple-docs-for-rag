...
``` source
func hv_gic_set_redistributor_reg(
    _ vcpu: hv_vcpu_t,
...
The enumeration value that represents the GIC redistributor register.

`value`  

The GIC distributor MSI register value that the framework writes.
