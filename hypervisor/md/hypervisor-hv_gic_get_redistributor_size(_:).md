...
``` source
func hv_gic_get_redistributor_size(_ redistributor_size: UnsafeMutablePointer) -> hv_return_t
```
...
A pointer to GIC redistributor region size value that the framework writes to upon success.
