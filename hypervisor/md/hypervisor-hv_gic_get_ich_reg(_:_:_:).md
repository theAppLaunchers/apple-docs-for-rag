...
``` source
func hv_gic_get_ich_reg(
    _ vcpu: hv_vcpu_t,
    _ reg: hv_gic_ich_reg_t,
...
The value that represents the GIC ICH system register.

`value`  

The pointer to ICH register value that the frameworks writes to upon success.
