...
``` source
func hv_gic_get_redistributor_reg(
    _ vcpu: hv_vcpu_t,
    _ reg: hv_gic_redistributor_reg_t,
...
The redistributor block for the vCPU.

`reg`  

The enumeration value that represents the redistributor register.

`value`  

A pointer to redistributor register value that the framework writes to upon success.
