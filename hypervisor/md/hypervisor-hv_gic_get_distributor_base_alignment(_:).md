...
``` source
func hv_gic_get_distributor_base_alignment(_ distributor_base_alignment: UnsafeMutablePointer) -> hv_return_t
```
...
A pointer to GIC distributor base address alignment value that the framework writes to upon success.
