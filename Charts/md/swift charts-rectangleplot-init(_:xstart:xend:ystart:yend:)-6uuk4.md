...
init(
    ...
    yStart: KeyPath.DataElement, CGFloat>,
    yEnd: KeyPath.DataElement, CGFloat>
) where Content == VectorizedRectanglePlotContent, Data : RandomAccessCollection, X : Plottable
```
