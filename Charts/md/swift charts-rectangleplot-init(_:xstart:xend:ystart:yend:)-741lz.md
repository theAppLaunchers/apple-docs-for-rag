...
init(
    _ data: Data,
    xStart: KeyPath.DataElement, CGFloat>,
    xEnd: KeyPath.DataElement, CGFloat>,
    yStart: PlottableProjection.DataElement, Y>,
    yEnd: PlottableProjection.DataElement, Y>
) where Content == VectorizedRectanglePlotContent, Data : RandomAccessCollection, Y : Plottable
```
