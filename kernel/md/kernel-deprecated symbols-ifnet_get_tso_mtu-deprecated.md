...
The family for which the offload MTU is provided for (AF_INET or AF_INET6)

`mtuLen`  

Value of the maximum MTU supported for the interface and family provided.
