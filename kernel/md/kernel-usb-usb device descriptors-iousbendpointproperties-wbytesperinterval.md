...
For SuperSpeed interrupt and isochronous endpoints, this is wBytesPerInterval from the SuperSpeed endpoint companion descriptor. For high-speed high-bandwidth isochronous endpoints, this is equal to `wMaxPacketSize` *\* (*`bMult`*+1)*.
