...
- Kernel
- Deprecated Symbols
-  ifnet_interface_family_find Deprecated
...
A unique string identifying your interface family

`family_id`  

Upon return, a unique interface family identifier for use with ifnet\_\* functions. This identifier is valid until the system is rebooted.
