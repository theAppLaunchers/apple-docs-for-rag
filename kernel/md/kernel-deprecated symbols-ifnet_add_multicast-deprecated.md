...
- Kernel
- Deprecated Symbols
-  ifnet_add_multicast Deprecated
...
The multicast address (AF_UNSPEC/AF_LINK) to join. Either a physical address or logical address to be translated to a physical address.
