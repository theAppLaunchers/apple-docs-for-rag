...
If TRUE, do not link the shadaow to 'bp' and if 'external_storage' == NULL, force a copy of the data associated with 'bp'.

`external_storage`  

If non-NULL, associate it with the new buffer as its storage instead of the storage currently associated with 'bp'.
