...
kern_return_t IMPL(CreatingMIDIDriverSampleAppDriver, Start)
{
   ...
   OSSharedPtr deviceName(OSString::withCString("CreatingMIDIDriverSampleAppDevice"), OSNoRetain);
   OSSharedPtr modelUID(OSString::withCString("CreatingMIDIDriverSampleAppDevice-Model"), OSNoRetain);
   OSSharedPtr manufacturerUID(OSString::withCString("Apple Inc."), OSNoRetain);
