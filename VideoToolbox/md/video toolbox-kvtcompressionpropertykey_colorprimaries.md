...
If a video encoder enforces specific colorimetry, this property will be read-only (VTSessionSetProperty(_:key:value:) returns kVTPropertyReadOnlyErr). The value is set on the format description for output sample buffers.
