...
For radio button or checkbox widgets, the value for this key is typically `Off` if the button isn’t in a selected state; otherwise, buttonWidgetStateString.
