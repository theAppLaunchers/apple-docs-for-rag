...
An inking item represents a PKInkingTool — a tool for drawing marks in a canvas view — in a PKToolPicker.

## Topics

### Creating an inking item

convenience init(type: PKInkingTool.InkType, color: UIColor?, width: CGFloat?, identifier: String?)
