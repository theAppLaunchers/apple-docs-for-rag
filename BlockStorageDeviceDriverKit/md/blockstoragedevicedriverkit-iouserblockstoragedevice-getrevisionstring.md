...
An in/out DeviceString parameter. On output, populate this structure with the revision string.

## Return Value

A value that indicates the get-revision-string result. Return kIOReturnSuccess to inidicate success. To indicate a failure, see IOKit Constants for error definitions.
