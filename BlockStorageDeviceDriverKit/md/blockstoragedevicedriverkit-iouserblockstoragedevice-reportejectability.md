...
An in/out Boolean parameter. On output, set this to `true` if the hardware supports ejecting the media.

## Return Value

A value that indicates the report-ejectability result. Return kIOReturnSuccess to inidicate success. To indicate a failure, see IOKit Constants for error definitions.
