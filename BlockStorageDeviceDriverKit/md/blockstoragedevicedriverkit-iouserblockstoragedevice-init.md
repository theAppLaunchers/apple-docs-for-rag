...
The system calls this method shortly after it instantiates your custom `IOUserBlockStorageDevice` subclass, and before it calls the Start method of your service. Limit the work you do in this method to simple tasks that must occur before your service starts. For example, use this method to allocate memory for your `ivars` structure.
