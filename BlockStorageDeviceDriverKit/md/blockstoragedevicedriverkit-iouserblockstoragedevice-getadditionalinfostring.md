...
An in/out DeviceString parameter. On output, populate this structure with the additional info string.

## Return Value

A value that indicates the get-additional-info result. Return kIOReturnSuccess to inidicate success. To indicate a failure, see IOKit Constants for error definitions.
