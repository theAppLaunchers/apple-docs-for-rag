...
If you receive suggestions using the foundSuggestionsHandler closure, the system provides the CSSuggestion objects directly. Extract the data from those objects and use it to build your views.
