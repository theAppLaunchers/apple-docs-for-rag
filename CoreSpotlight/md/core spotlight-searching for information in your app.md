...
- Specify a floating-point value with the number of seconds relative to January 1, 2001. You can get this value from a doc://com.apple.documentation/documentation/corefoundation/cfdate-rv5 or Date type using the CFDateGetAbsoluteTime(_:) function.
