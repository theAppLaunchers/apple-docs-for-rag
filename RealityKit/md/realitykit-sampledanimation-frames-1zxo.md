...
``` source
var frames: [SIMD3] { get set }
```

Available when `Value` is `SIMD3`.

## Discussion

This array contains sequential values for the animated property when bindTarget is an array of simd floating-point triplets.
