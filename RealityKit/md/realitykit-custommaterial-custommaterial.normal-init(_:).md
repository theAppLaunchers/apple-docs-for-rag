...
The normal object from a PhysicallyBasedMaterial.

## Discussion

This initializer creates an object by copying the normal map from the normal property of a PhysicallyBasedMaterial.
