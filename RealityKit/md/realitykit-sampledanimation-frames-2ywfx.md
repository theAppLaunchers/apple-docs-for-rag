...
``` source
var frames: [SIMD4] { get set }
```

Available when `Value` is `SIMD4`.

## Discussion

This array contains sequential values for the animated property when bindTarget is an array of simd floating-point quadruplets.
